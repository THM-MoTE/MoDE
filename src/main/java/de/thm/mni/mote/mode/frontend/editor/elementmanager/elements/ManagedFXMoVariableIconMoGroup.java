...
//    corners[0] = new ModifyableCircle(this, mcs.getExtent().getP2().getX(), mcs.getExtent().getP2().getY(), ModifyableCircle.MODIFY_NO_OFFSET);
  ...
  public void enterSelection() {
    this.getCoordinateSystem().setStroke(Color.RED);
    this.getCoordinateSystem().setOpacity(1);
  ...
  public void leaveSelection() {
    ...
    this.getCoordinateSystem().setStroke(null);
  }
  
  @Override
  public void enterHover() {
    this.getCoordinateSystem().setStroke(Color.LIGHTCORAL);
    this.getCoordinateSystem().setOpacity(1);
  }
