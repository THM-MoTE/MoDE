 ...
 * /de/thm/mni/mote/mode/view/fragments/SelectProjectLibs.fxml
 */
public class SelectProjectLibsController implements Initializable {
  ...
  private void onSelectLibrary(ActionEvent event) {
    ...
    if (f != null && f.exists()) pLibrary.set(PackageParser.findBasePackage(Constants.ALLGROUPS, f.toPath()));
  }
