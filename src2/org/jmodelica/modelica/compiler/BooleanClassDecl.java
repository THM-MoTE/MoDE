...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:146
 * @production BooleanClassDecl : {@link PrimitiveClassDecl};

 */
public class BooleanClassDecl extends PrimitiveClassDecl implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public BooleanClassDecl() {
        super();
    }
    /**
     ...
     */
    public BooleanClassDecl clone() throws CloneNotSupportedException {
        BooleanClassDecl node = (BooleanClassDecl) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public BooleanClassDecl copy() {
        try {
            BooleanClassDecl node = (BooleanClassDecl) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public BooleanClassDecl fullCopy() {
     ...
     */
    public BooleanClassDecl treeCopyNoTransform() {
        BooleanClassDecl tree = (BooleanClassDecl) copy();
        if (children != null) {
     ...
     */
    public BooleanClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /**
