...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:311
 * @production IfWhenEquation : {@link IfWhenElseEquation} ::= <span class="component">Test:{@link Exp}</span> <span class="component">[Else:{@link IfWhenElseEquation}]</span>;

 */
public abstract class IfWhenEquation extends IfWhenElseEquation implements Cloneable {
    /**
     * @aspect InstantiatedExpressions
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Flattening.jrag:2853
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:777
     */
    @Override
    ...
    /**
     * @aspect FormattedPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1639
     */
    ...
    /**
     * @aspect FormattedPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1643
     */
    void prettyPrintFormattedHelper(Printer printer, CodeStream printStream, boolean elseIfWhen) {
		if (elseIfWhen) {
     ...
     */
    public IfWhenEquation(Opt<AbstractEquationModifier> p0, Comment p1, List<AbstractEquation> p2, Exp p3, Opt<IfWhenElseEquation> p4) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public IfWhenEquation clone() throws CloneNotSupportedException {
        IfWhenEquation node = (IfWhenEquation) super.clone();
        return node;
    }
    /**
     ...
     */
    public abstract IfWhenEquation fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract IfWhenEquation treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract IfWhenEquation treeCopy();
    /**
     ...
     * @attribute syn
     * @aspect FormattedPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1635
     */
