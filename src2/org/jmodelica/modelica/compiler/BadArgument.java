...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Error.ast:20
 * @production BadArgument : {@link Argument};

 */
public class BadArgument extends Argument implements Cloneable {
    /**
     * @aspect ErrorClasses
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/ErrorClasses.jrag:30
     */
    ...
    /**
     * @aspect ErrorClasses
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/ErrorClasses.jrag:53
     */
    ...
    /**
     * @aspect ErrorClasses
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/ErrorClasses.jrag:89
     */
    private BadNodeInfo badNodeInfo = null;
    /**
     * @aspect ErrorClasses
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/ErrorClasses.jrag:110
     */
    ...
    /**
     * @aspect ErrorClasses
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/ErrorClasses.jrag:143
     */
     ...
     */
    public BadArgument(Opt<Each> p0, Opt<Final> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /**
     ...
     */
    public BadArgument clone() throws CloneNotSupportedException {
        BadArgument node = (BadArgument) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public BadArgument copy() {
        try {
            BadArgument node = (BadArgument) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public BadArgument treeCopyNoTransform() {
        BadArgument tree = (BadArgument) copy();
        if (children != null) {
