...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/InstanceTree.ast:120
 * @production InstExpandableConnectorMember : {@link InstComponentDecl} ::= <span class="component">&lt;CopyOf:InstComponentDecl&gt;</span> <span class="component">&lt;Name:String&gt;</span>;

 */
public class InstExpandableConnectorMember extends InstComponentDecl implements Cloneable {
    /**
     * @aspect Connections
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Connections.jrag:1187
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Connections.jrag:2811
     */
    ...
    /**
     * @aspect Flattening
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Flattening.jrag:958
     */
    public void flatten(FClass fc, boolean excludeBinding, int level) {
        if (getCopyOf().isAssignable())
            getCopyOf().flatten(fc, getFQName(), true, level);
        else
            flatten(fc, getFQName(), true, level);
    }
    /**
     * @aspect ExpandableConnectorMembers
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1688
     */
    public InstExpandableConnectorMember(InstComponentDecl org, Opt<FArraySubscripts> subscripts, String name) {
        this(null, subscripts, org.getComponentDecl(), new Opt(), new Opt(), new Opt(), org, name);
    }
    /**
     * @aspect ExpandableConnectorMembers
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1717
     */
     ...
     */
    public InstExpandableConnectorMember() {
        super();
    }
    /**
     ...
     */
    public InstExpandableConnectorMember(InstAccess p0, Opt<FArraySubscripts> p1, ComponentDecl p2, Opt<InstModification> p3, Opt<InstConstrainingComponent> p4, Opt<FExp> p5, InstComponentDecl p6, String p7) {
        setChild(p0, 0);
        setChild(p1, 1);
        setComponentDecl(p2);
        setChild(p3, 2);
     ...
     */
    public InstExpandableConnectorMember(InstAccess p0, Opt<FArraySubscripts> p1, ComponentDecl p2, Opt<InstModification> p3, Opt<InstConstrainingComponent> p4, Opt<FExp> p5, InstComponentDecl p6, Symbol p7) {
        setChild(p0, 0);
        setChild(p1, 1);
        setComponentDecl(p2);
        setChild(p3, 2);
     ...
     */
    public InstExpandableConnectorMember clone() throws CloneNotSupportedException {
        InstExpandableConnectorMember node = (InstExpandableConnectorMember) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public InstExpandableConnectorMember copy() {
        try {
            InstExpandableConnectorMember node = (InstExpandableConnectorMember) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public InstExpandableConnectorMember fullCopy() {
     ...
     */
    public InstExpandableConnectorMember treeCopyNoTransform() {
        InstExpandableConnectorMember tree = (InstExpandableConnectorMember) copy();
        if (children != null) {
     ...
     */
    public InstExpandableConnectorMember treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /**
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenComponentDecl_ComponentDecl == ((InstExpandableConnectorMember)node).tokenComponentDecl_ComponentDecl) && (tokenInstComponentDecl_CopyOf == ((InstExpandableConnectorMember)node).tokenInstComponentDecl_CopyOf) && (tokenString_Name == ((InstExpandableConnectorMember)node).tokenString_Name);    
    }
    /**
    ...
    /**
     * Replaces the lexeme CopyOf.
     * @param value The new value for the lexeme CopyOf.
     * @apilevel high-level
     */
    public void setCopyOf(InstComponentDecl value) {
        tokenInstComponentDecl_CopyOf = value;
    }
    /**
     * @apilevel internal
     */
    protected InstComponentDecl tokenInstComponentDecl_CopyOf;
    /**
     * Retrieves the value for the lexeme CopyOf.
     * @return The value for the lexeme CopyOf.
     * @apilevel high-level
     */
    @ASTNodeAnnotation.Token(name="CopyOf")
    public InstComponentDecl getCopyOf() {
        return tokenInstComponentDecl_CopyOf;
    }
    /**
    ...
    public InstComponentDecl findCellDown(Index i, int j) {
        ...
        InstComponentDecl findCellDown_Index_int_value = getCopyOf().isPrimitive() ? this : super.findCellDown(i, j);
    ...
    public boolean isPresent() {
        ASTNode$State state = state();
        boolean isPresent_value = getCopyOf().isPresent();
    ...
    public boolean isExpandableConnectorMember() {
        ASTNode$State state = state();
        boolean isExpandableConnectorMember_value = true;
    ...
    public List getInstComponentDeclList() {
        ...
        getInstComponentDeclList_value = getCopyOf().getInstComponentDeclList().fullCopy();
    ...
    public List getInstClassDeclList() {
        ...
        int num = state.boundariesCrossed;
        boolean isFinal = this.is$Final();
        getInstClassDeclList_value = getCopyOf().getInstClassDeclList().fullCopy();
    ...
    public List getInstExtendsList() {
        ...
        int num = state.boundariesCrossed;
        boolean isFinal = this.is$Final();
        getInstExtendsList_value = getCopyOf().getInstExtendsList().fullCopy();
    ...
    public List getInstImportList() {
        ASTNode$State state = state();
        List getInstImportList_value = getCopyOf().getInstImportList().fullCopy();
    ...
    public List getRedeclaredInstClassDeclList() {
        ...
        int num = state.boundariesCrossed;
        boolean isFinal = this.is$Final();
        getRedeclaredInstClassDeclList_value = getCopyOf().getRedeclaredInstClassDeclList().fullCopy();
    ...
    public List getFAbstractEquationList() {
        ...
        int num = state.boundariesCrossed;
        boolean isFinal = this.is$Final();
        getFAbstractEquationList_value = getCopyOf().getFAbstractEquationList().fullCopy();
    ...
    public InstClassDecl myInstClass() {
        ASTNode$State state = state();
        InstClassDecl myInstClass_value = getCopyOf().myInstClass();
    ...
    public FTypePrefixVariability defaultVariability() {
        ASTNode$State state = state();
        FTypePrefixVariability defaultVariability_value = getCopyOf().defaultVariability();
    ...
    public boolean isAssignable() {
        ASTNode$State state = state();
        boolean isAssignable_value = getCopyOf().isAssignable();
    ...
    public boolean connectableTo(InstComponentDecl other) {
        ASTNode$State state = state();
        boolean connectableTo_InstComponentDecl_value = getCopyOf().connectableTo(other);
    ...
    public boolean connectableTypes(InstComponentDecl other) {
        ASTNode$State state = state();
        boolean connectableTypes_InstComponentDecl_value = getCopyOf().connectableTypes(other);
