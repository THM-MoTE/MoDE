...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:322
 * @production ForIndexDecl : {@link ComponentDecl};

 */
public class ForIndexDecl extends ComponentDecl implements Cloneable {
    /**
     ...
     */
    public ForIndexDecl clone() throws CloneNotSupportedException {
        ForIndexDecl node = (ForIndexDecl) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public ForIndexDecl copy() {
        try {
            ForIndexDecl node = (ForIndexDecl) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public ForIndexDecl treeCopyNoTransform() {
        ForIndexDecl tree = (ForIndexDecl) copy();
        if (children != null) {
