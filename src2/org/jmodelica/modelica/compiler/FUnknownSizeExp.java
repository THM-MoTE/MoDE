...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/ast/FlatModelica.ast:1588
...
public class FUnknownSizeExp extends FSizeExp implements Cloneable {
    /**
     * @aspect Constructors
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/Constructors.jrag:469
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/Sizes.jrag:350
     */
     ...
     */
    public FUnknownSizeExp(FExp p0, Opt<FExp> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /**
    ...
    public boolean isCircularCalc() {
        ASTNode$State state = state();
        boolean isCircularCalc_value = getDim().isCircular() || ((FIdUseExp)getFExp()).getFIdUse().isCircular(dimension());
    ...
    public FTypePrefixVariability expVariability() {
        ASTNode$State state = state();
        FTypePrefixVariability expVariability_value = fParameter().combine(getDim().variability());
