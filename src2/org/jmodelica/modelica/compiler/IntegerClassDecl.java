...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:145
 * @production IntegerClassDecl : {@link PrimitiveClassDecl};

 */
public class IntegerClassDecl extends PrimitiveClassDecl implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public IntegerClassDecl() {
        super();
    }
    /**
     ...
     */
    public IntegerClassDecl clone() throws CloneNotSupportedException {
        IntegerClassDecl node = (IntegerClassDecl) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public IntegerClassDecl copy() {
        try {
            IntegerClassDecl node = (IntegerClassDecl) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public IntegerClassDecl fullCopy() {
     ...
     */
    public IntegerClassDecl treeCopyNoTransform() {
        IntegerClassDecl tree = (IntegerClassDecl) copy();
        if (children != null) {
     ...
     */
    public IntegerClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /**
