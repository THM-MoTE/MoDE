...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:310
 * @production IfWhenElseEquation : {@link AbstractEquation} ::= <span class="component">{@link AbstractEquation}*</span>;

 */
public abstract class IfWhenElseEquation extends AbstractEquation implements Cloneable {
    /**
     * @aspect InstantiatedExpressions
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Flattening.jrag:2845
     */
    protected FIfWhenElseEquation instantiate(FIfWhenElseEquation res) {
        ...
        return contribute(res);
    }
    /**
     * @aspect InstantiatedExpressions
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Flattening.jrag:2861
     */
    public abstract FIfWhenElseEquation instantiate();
    /**
     * @aspect FormattedPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1634
     */
    abstract void prettyPrintFormattedHelper(Printer printer, CodeStream printStream, boolean elseIfWhen);
    /**
     * @declaredat ASTNode:1
     */
    public IfWhenElseEquation() {
        super();
    }
    /**
     ...
     */
    public IfWhenElseEquation(Opt<AbstractEquationModifier> p0, Comment p1, List<AbstractEquation> p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
     ...
     */
    public IfWhenElseEquation clone() throws CloneNotSupportedException {
        IfWhenElseEquation node = (IfWhenElseEquation) super.clone();
        return node;
    }
    /**
     ...
     */
    public abstract IfWhenElseEquation fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract IfWhenElseEquation treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract IfWhenElseEquation treeCopy();
    /**
