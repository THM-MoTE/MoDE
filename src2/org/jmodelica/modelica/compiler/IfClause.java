...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:334
 * @production IfClause : {@link IfWhenClause};

 */
public class IfClause extends IfWhenClause implements Cloneable {
    /**
     * @aspect InstantiatedExpressions
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Flattening.jrag:2997
     */
     ...
     */
    public IfClause(Exp p0, List<Statement> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /**
     ...
     */
    public IfClause clone() throws CloneNotSupportedException {
        IfClause node = (IfClause) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public IfClause copy() {
        try {
            IfClause node = (IfClause) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public IfClause treeCopyNoTransform() {
        IfClause tree = (IfClause) copy();
        if (children != null) {
