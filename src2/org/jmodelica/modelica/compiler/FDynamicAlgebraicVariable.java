 ...
 * by dynamic states.
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/ast/FlatModelica.ast:308
...
public class FDynamicAlgebraicVariable extends FRealVariable implements Cloneable {
     ...
     * @aspect Constructors
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/Constructors.jrag:754
     */
    public FDynamicAlgebraicVariable(DynamicStateSet set, int number) {
        this(new FPublicVisibilityType(), new FContinuous(), new Opt(), new List(), (String)null, new Opt(), new Opt(), new FQNameFull("_ds." + set.id() + ".a" + number), set, number);
    }
    /**
     ...
     */
    public FDynamicAlgebraicVariable(FVisibilityType p0, FTypePrefixVariability p1, Opt<FTypePrefixInputOutput> p2, List<FAttribute> p3, String p4, Opt<FExp> p5, Opt<FStringComment> p6, FQName p7, DynamicStateSet p8, int p9) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public FDynamicAlgebraicVariable(FVisibilityType p0, FTypePrefixVariability p1, Opt<FTypePrefixInputOutput> p2, List<FAttribute> p3, Symbol p4, Opt<FExp> p5, Opt<FStringComment> p6, FQName p7, DynamicStateSet p8, int p9) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_DerivedType == ((FDynamicAlgebraicVariable)node).tokenString_DerivedType) && (tokenDynamicStateSet_Set == ((FDynamicAlgebraicVariable)node).tokenDynamicStateSet_Set) && (tokenint_Number == ((FDynamicAlgebraicVariable)node).tokenint_Number);    
    }
    /**
     ...
     * @attribute coll
     * @aspect FlatAPI
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/FlatAPI.jrag:725
     */
            {
                FClass ref = (FClass) (myFClass());
                if (ref != null) {
                    ref.FClass_dynamicAlgebraicVariables_contributors().add(this);
                }
            }
    ...
    protected void contributeTo_FClass_FClass_dynamicAlgebraicVariables(LinkedHashSet<FDynamicAlgebraicVariable> collection) {
        super.contributeTo_FClass_FClass_dynamicAlgebraicVariables(collection);
        collection.add(this);
    }
