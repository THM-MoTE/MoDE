...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:245
 * @production SiblingComponentDecl : {@link ComponentDecl} ::= <span class="component">&lt;Siblings:java.util.List<SiblingComponentDecl>&gt;</span>;

 */
public class SiblingComponentDecl extends ComponentDecl implements Cloneable {
    /**
     * @aspect FormattedPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1861
     */
    ...
    /**
     * @aspect FormattedPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1889
     */
    ...
    /**
     * @aspect FormattedPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1899
     */
    void prettyPrintFormattedSiblingDecl(Printer printer, CodeStream printStream, boolean first) {
		if (!first)
     ...
     */
    public SiblingComponentDecl clone() throws CloneNotSupportedException {
        SiblingComponentDecl node = (SiblingComponentDecl) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public SiblingComponentDecl copy() {
        try {
            SiblingComponentDecl node = (SiblingComponentDecl) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public SiblingComponentDecl fullCopy() {
     ...
     */
    public SiblingComponentDecl treeCopyNoTransform() {
        SiblingComponentDecl tree = (SiblingComponentDecl) copy();
        if (children != null) {
     ...
     */
    public SiblingComponentDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /**
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenjava_util_List_SiblingComponentDecl__Siblings == ((SiblingComponentDecl)node).tokenjava_util_List_SiblingComponentDecl__Siblings);    
    }
    /**
    ...
    /**
     * Replaces the lexeme Siblings.
     * @param value The new value for the lexeme Siblings.
     * @apilevel high-level
     */
    public void setSiblings(java.util.List<SiblingComponentDecl> value) {
        tokenjava_util_List_SiblingComponentDecl__Siblings = value;
    }
    /**
     * @apilevel internal
     */
    protected java.util.List<SiblingComponentDecl> tokenjava_util_List_SiblingComponentDecl__Siblings;
    /**
     * Retrieves the value for the lexeme Siblings.
     * @return The value for the lexeme Siblings.
     * @apilevel high-level
     */
    @ASTNodeAnnotation.Token(name="Siblings")
    public java.util.List<SiblingComponentDecl> getSiblings() {
        return tokenjava_util_List_SiblingComponentDecl__Siblings;
    }
    /**
     * @apilevel internal
     */
