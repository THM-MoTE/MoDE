...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:371
 * @production IterExp : {@link Exp} ::= <span class="component">{@link Exp}</span> <span class="component">{@link ForIndex}*</span>;

 */
public class IterExp extends Exp implements Cloneable {
    /**
     * @aspect InstantiatedExpressions
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Flattening.jrag:3061
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1772
     */
     ...
     */
    public IterExp(Exp p0, List<ForIndex> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /**
     ...
     */
    public IterExp clone() throws CloneNotSupportedException {
        IterExp node = (IterExp) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public IterExp treeCopyNoTransform() {
        IterExp tree = (IterExp) copy();
        if (children != null) {
