 ...
 * @ast class
 * @aspect CCodeGen
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaCBackEnd/src/jastadd/CCodeGen.jrag:220
 */
public class CPrettyPrinter extends CodePrinter {
        ...
        public CPrettyPrinter(boolean inBlock) {
            this(inBlock, false, Homotopy.HOMOTOPY, true);
        }

    

        protected CPrettyPrinter(boolean inBlock, boolean inInitialSystem, Homotopy homotopyType,
        ...
        protected CodePrinter createPrinter(boolean inBlock, boolean inInitialSystem, Homotopy homotopyType,
                boolean writeSwitches) {
            return new CPrettyPrinter(inBlock, inInitialSystem, homotopyType, writeSwitches);
        }
        ...
        @Override
        public void printWriteBackAssignment(CodeStream str, String indent, FFunctionCallLeft left, Collection<FVariable> forVariables) {
            FExp e = left.getFExp();
            FType t = e.type();
            WriteBackAssignmentPrinter p = t.isComposite() && !left.inFunction() ? 
                    new ArrayWriteBackAssignmentPrinter(forVariables) :
                    new WriteBackAssignmentPrinter(forVariables);
            p.print(str, indent, t, left.name_C(), e);
        }
