 ...
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/ast/FlatModelica.ast:1691
...
public class FMinExp extends FMinMaxExp implements Cloneable {
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/Constructors.jrag:1160
     */
     ...
     */
    public FMinExp(FExp p0, Opt<FExp> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /**
    ...
    public FExp scalarReduceExp(FExp reducer, FExp scalar) {
        ASTNode$State state = state();
        FExp scalarReduceExp_FExp_FExp_value = new FIfExp(new FLtExp(reducer.unboundCopy(), scalar.unboundCopy()), reducer.unboundCopy(), scalar.unboundCopy());
