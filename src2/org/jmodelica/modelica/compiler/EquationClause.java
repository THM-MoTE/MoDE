...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:203
 * @production EquationClause : {@link Clause} ::= <span class="component">{@link AbstractEquation}*</span>;

 */
public class EquationClause extends Clause implements Cloneable {
    /**
     * @aspect InitialTransformations
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/InitialTransformations.jrag:258
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:636
     */
    @Override
    ...
    /**
     * @aspect FormattedPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1443
     */
     ...
     */
    public EquationClause(List<AbstractEquation> p0) {
        setChild(p0, 0);
    }
    /**
     * @apilevel low-level
     ...
     */
    public EquationClause clone() throws CloneNotSupportedException {
        EquationClause node = (EquationClause) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public EquationClause copy() {
        try {
            EquationClause node = (EquationClause) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public EquationClause fullCopy() {
     ...
     */
    public EquationClause treeCopyNoTransform() {
        EquationClause tree = (EquationClause) copy();
        if (children != null) {
     ...
     */
    public EquationClause treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /**
    ...
    public List<AbstractEquation> getAbstractEquationList() {
        List<AbstractEquation> list = (List<AbstractEquation>) getChild(0);
        list.getNumChild();
        return list;
    }
    /**
    ...
    public List<AbstractEquation> getAbstractEquationListNoTransform() {
        return (List<AbstractEquation>) getChildNoTransform(0);
    }
    /**
     * Retrieves the AbstractEquation list.
     * @return The node representing the AbstractEquation list.
