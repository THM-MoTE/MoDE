...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:404
 * @production MatrixRow : {@link Exp} ::= <span class="component">{@link Exp}*</span>;

 */
public class MatrixRow extends Exp implements Cloneable {
    /**
     * @aspect PrettyPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/PrettyPrint.jrag:878
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Flattening.jrag:3090
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1163
     */
     ...
     */
    public MatrixRow clone() throws CloneNotSupportedException {
        MatrixRow node = (MatrixRow) super.clone();
        return node;
    }
    /**
     * @apilevel internal
    ...
    public MatrixRow copy() {
        try {
            MatrixRow node = (MatrixRow) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public MatrixRow treeCopyNoTransform() {
        MatrixRow tree = (MatrixRow) copy();
        if (children != null) {
