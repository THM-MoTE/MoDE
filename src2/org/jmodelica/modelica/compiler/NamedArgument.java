...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:369
 * @production NamedArgument : {@link SourceBaseNode} ::= <span class="component">Name:{@link Access}</span> <span class="component">{@link Exp}</span>;

 */
public class NamedArgument extends SourceBaseNode implements Cloneable {
    /**
     * @aspect InstantiatedExpressions
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Flattening.jrag:3212
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1697
     */
     ...
     */
    public NamedArgument(Access p0, Exp p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /**
     ...
     */
    public NamedArgument clone() throws CloneNotSupportedException {
        NamedArgument node = (NamedArgument) super.clone();
        return node;
    }
    /**
     * @apilevel internal
    ...
    public NamedArgument copy() {
        try {
            NamedArgument node = (NamedArgument) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public NamedArgument treeCopyNoTransform() {
        NamedArgument tree = (NamedArgument) copy();
        if (children != null) {
    ...
    public AnnotationNode annotationNode() {
        ...
        annotationNode_value = new NAAnnotationNode(this);
