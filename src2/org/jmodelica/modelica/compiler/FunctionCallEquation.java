...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:316
 * @production FunctionCallEquation : {@link AbstractEquation} ::= <span class="component">Left:{@link FunctionCallLeft}*</span> <span class="component">Call:{@link FunctionCall}</span>;

 */
public class FunctionCallEquation extends AbstractEquation implements Cloneable {
    /**
     * @aspect InstantiatedExpressions
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Flattening.jrag:2875
     */
    public FFunctionCallEquation instantiate() {
        ...
        for (FunctionCallLeft a : getLefts()) 
            l.add(a.instantiate());
        return contribute(copyLocationTo(new FFunctionCallEquation(equationType(), l, getCall().instantiate())));
    }
    /**
     * @aspect FormattedPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:501
     */
    @Override
    ...
    /**
     * @aspect FormattedPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1595
     */
     ...
     */
    public FunctionCallEquation(Opt<AbstractEquationModifier> p0, Comment p1, List<FunctionCallLeft> p2, FunctionCall p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public FunctionCallEquation clone() throws CloneNotSupportedException {
        FunctionCallEquation node = (FunctionCallEquation) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public FunctionCallEquation copy() {
        try {
            FunctionCallEquation node = (FunctionCallEquation) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public FunctionCallEquation fullCopy() {
     ...
     */
    public FunctionCallEquation treeCopyNoTransform() {
        FunctionCallEquation tree = (FunctionCallEquation) copy();
        if (children != null) {
     ...
     */
    public FunctionCallEquation treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /**
    ...
    public List<FunctionCallLeft> getLeftList() {
        List<FunctionCallLeft> list = (List<FunctionCallLeft>) getChild(2);
        list.getNumChild();
        return list;
    }
    /**
    ...
    public List<FunctionCallLeft> getLeftListNoTransform() {
        return (List<FunctionCallLeft>) getChildNoTransform(2);
    }
    /**
     * Retrieves the Left list.
     * @return The node representing the Left list.
     ...
     * @apilevel high-level
     */
    public void setCall(FunctionCall node) {
        setChild(node, 3);
    }
    /**
    ...
    public FunctionCall getCall() {
        return (FunctionCall) getChild(3);
    }
    /**
     * Retrieves the Call child.
     * <p><em>This method does not invoke AST transformations.</em></p>
     ...
     * @apilevel low-level
     */
    public FunctionCall getCallNoTransform() {
        return (FunctionCall) getChildNoTransform(3);
    }
    /**
     * @apilevel internal
     */
