 ...
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/ast/FlatModelica.ast:771
...
public class FWhenStmt extends FIfWhenStmt implements Cloneable {
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/Constructors.jrag:1398
     */
    public FWhenStmt createEmptyNode() { return new FWhenStmt(); }
    /**
     * @aspect Variability
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/Variability.jrag:255
     */
    ...
    /**
     * @aspect ContentCheck
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/ContentsCheck.jadd:86
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/FlatteningStatements.jrag:100
     */
    protected FIfWhenStmt flattenFIfWhenStmt(FClass fc, FQName prefix, List l) {
        return new FWhenStmt(l);
    }
    /**
     * @aspect TransformCanonical
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/TransformCanonical.jrag:1054
     */
    public void acceptTransform(AlgorithmTransformer tf)   { tf.visit(this); }
    /**
     * @aspect WhenClauses
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/optimizations/WhenTransformation.jrag:92
     */
    @Override
     ...
     * @attribute syn
     * @aspect FlatAPI
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/FlatAPI.jrag:1319
     */
     ...
     * @attribute coll
     * @aspect FlatAPI
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/FlatAPI.jrag:1302
     */
        if (inEquationSection()) {
            {
                FClass ref = (FClass) (myFClass());
                if (ref != null) {
                    ref.FClass_guardExpInEquations_contributors().add(this);
                }
            }
        }
        super.collect_contributors_FClass_guardExpInEquations();
    }
    protected void collect_contributors_FClass_guardExpInInitialEquations() {
    /**
     * @attribute coll
     * @aspect FlatAPI
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/FlatAPI.jrag:1309
     */
        if (inInitialEquationSection()) {
            {
                FClass ref = (FClass) (myFClass());
                if (ref != null) {
                    ref.FClass_guardExpInInitialEquations_contributors().add(this);
                }
            }
        }
        super.collect_contributors_FClass_guardExpInInitialEquations();
    }
    protected void contributeTo_FClass_FClass_guardExpInEquations(ArrayList<FExp> collection) {
        super.contributeTo_FClass_FClass_guardExpInEquations(collection);
        if (inEquationSection())
            collection.addAll(guards());
    }

    protected void contributeTo_FClass_FClass_guardExpInInitialEquations(ArrayList<FExp> collection) {
        super.contributeTo_FClass_FClass_guardExpInInitialEquations(collection);
        if (inInitialEquationSection())
            collection.addAll(guards());
    }
