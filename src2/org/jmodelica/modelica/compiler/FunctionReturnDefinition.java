...
/**
 * @ast class
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/GenericCodeGen/src/jastadd/FunctionReturnDefinition.jadd:26
 */
public class FunctionReturnDefinition extends Object {
    private  ArrayList<FFunctionVariable> outputs;

    private  FFunctionDecl decl;

    public  FunctionReturnDefinition(FFunctionDecl decl) {
	    this.decl = decl;
		outputs = decl.myOutputs();
	}
    ...
    public String getDeclaredType_C() {
		if (outputs.size() > 0) 
    ...
    public void printReturnForExp_C(CodeStream str, String indent) {
		str.print(indent);
		str.print("return");
		if (outputs.size() > 0) { 
			str.print(" ");
