...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:309
 * @production ConnectClause : {@link AbstractEquation} ::= <span class="component">{@link Comment}</span> <span class="component">Connector1:{@link Access}</span> <span class="component">Connector2:{@link Access}</span>;

 */
public class ConnectClause extends AbstractEquation implements Cloneable {
    /**
     * @aspect PrettyPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/PrettyPrint.jrag:694
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Flattening.jrag:2832
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1585
     */
     ...
     */
    public ConnectClause(Opt<AbstractEquationModifier> p0, Comment p1, Access p2, Access p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public ConnectClause clone() throws CloneNotSupportedException {
        ConnectClause node = (ConnectClause) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public ConnectClause copy() {
        try {
            ConnectClause node = (ConnectClause) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public ConnectClause treeCopyNoTransform() {
        ConnectClause tree = (ConnectClause) copy();
        if (children != null) {
     ...
     * @apilevel high-level
     */
    public void setConnector1(Access node) {
        setChild(node, 2);
    }
    /**
     ...
     * @apilevel low-level
     */
    public Access getConnector1NoTransform() {
     ...
     * @apilevel high-level
     */
    public void setConnector2(Access node) {
        setChild(node, 3);
    }
    /**
     ...
     * @apilevel low-level
     */
    public Access getConnector2NoTransform() {
