...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/InstanceTree.ast:113
...
public class InstEnumLiteral extends InstBuiltIn implements Cloneable {
    /**
     * @aspect Flattening
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Flattening.jrag:1084
     */
     ...
     */
    public InstEnumLiteral(InstAccess p0, Opt<FArraySubscripts> p1, ComponentDecl p2, Opt<InstModification> p3, Opt<InstConstrainingComponent> p4, Opt<FExp> p5) {
        setChild(p0, 0);
        setChild(p1, 1);
        setComponentDecl(p2);
        setChild(p3, 2);
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenComponentDecl_ComponentDecl == ((InstEnumLiteral)node).tokenComponentDecl_ComponentDecl);    
    }
    /**
    ...
    public FQName appendMyName(FQName prefix) {
        ASTNode$State state = state();
        FQName appendMyName_FQName_value = prefix.copyAndAppend(name());
    ...
    public FTypePrefixVariability calcVariability() {
        ASTNode$State state = state();
        FTypePrefixVariability calcVariability_value = fConstant();
