...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:211
 * @production ImportClause : {@link Element} ::= <span class="component">PackageName:{@link Access}</span> <span class="component">{@link Comment}</span>;

 */
public abstract class ImportClause extends Element implements Cloneable {
    /**
     * @aspect InstImportClauses
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1814
     */
    public abstract InstImport newInstImport();
    /**
     * @aspect InitialTransformations
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/InitialTransformations.jrag:254
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:872
     */
    @Override
    ...
    /**
     * @aspect FormattedPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1385
     */
     ...
     */
    public ImportClause(Access p0, Comment p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /**
     ...
     */
    public ImportClause clone() throws CloneNotSupportedException {
        ImportClause node = (ImportClause) super.clone();
        return node;
    }
    /**
     ...
     */
    public abstract ImportClause fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract ImportClause treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     * @apilevel low-level
     */
    public Access getPackageNameNoTransform() {
    ...
    public ClassDecl findClassDecl() {
        ...
        ClassDecl findClassDecl_value = getPackageName().findClassDecl();

        return findClassDecl_value;
    }
    @ASTNodeAnnotation.Attribute
    public ClassDecl simpleLookupClassInImport(String name) {
        ASTNode$State state = state();
        ClassDecl simpleLookupClassInImport_String_value = matches(name) ? findClassDecl() : unknownClassDecl();

        return simpleLookupClassInImport_String_value;
    }
    /**
     * @attribute inh
     * @aspect SimpleClassLookup
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/SimpleLookup.jrag:90
     */
    @ASTNodeAnnotation.Attribute
    ...
    public ClassDecl Define_simpleLookupClass(ASTNode caller, ASTNode child, String name) {
        if (caller == getPackageNameNoTransform()) {
            return simpleLookupClassGlobalScope(name);
        }
        else {
