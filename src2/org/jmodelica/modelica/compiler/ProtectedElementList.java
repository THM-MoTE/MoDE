...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:202
 * @production ProtectedElementList : {@link ElementList};

 */
public class ProtectedElementList extends ElementList implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public ProtectedElementList() {
        super();
    }
    /**
     ...
     */
    public ProtectedElementList(List<Element> p0) {
        setChild(p0, 0);
    }
    /**
     * @apilevel low-level
     ...
     */
    public ProtectedElementList clone() throws CloneNotSupportedException {
        ProtectedElementList node = (ProtectedElementList) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public ProtectedElementList copy() {
        try {
            ProtectedElementList node = (ProtectedElementList) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public ProtectedElementList fullCopy() {
     ...
     */
    public ProtectedElementList treeCopyNoTransform() {
        ProtectedElementList tree = (ProtectedElementList) copy();
        if (children != null) {
     ...
     */
    public ProtectedElementList treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /**
    ...
    public VisibilityType Define_visibility(ASTNode caller, ASTNode child) {
        if (caller == getElementListNoTransform()) {
            ...
            return new ProtectedVisibilityType();
        }
        else {
    ...
    public ASTNode rewriteTo() {
        // Declared at @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/InitialTransformations.jrag:341
    ...
    /**
     * @declaredat @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/InitialTransformations.jrag:341
     * @apilevel internal
