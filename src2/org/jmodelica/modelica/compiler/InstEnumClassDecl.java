...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/InstanceTree.ast:51
...
public class InstEnumClassDecl extends InstPrimitiveClassDecl implements Cloneable {
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1242
     */
     ...
     */
    public InstEnumClassDecl(ClassDecl p0, Opt<InstConstrainingClass> p1, InstRestriction p2, Opt<InstExternal> p3) {
        setClassDecl(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setChild(p3, 2);
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenClassDecl_ClassDecl == ((InstEnumClassDecl)node).tokenClassDecl_ClassDecl);    
    }
    /**
    ...
    public FQName Define_retrieveFQName(ASTNode caller, ASTNode child) {
        ...
        return new FQNameString(qualifiedName());
    }
    /**
    ...
    public InstEnumClassDecl Define_myInstEnumClassDecl(ASTNode caller, ASTNode child) {
        if (caller == getInstComponentDeclListNoTransform()) {
            ...
            return super.Define_myInstEnumClassDecl(caller, child);
        }
    }
    /**
    ...
    public int Define_myIndex(ASTNode caller, ASTNode child) {
        if (caller == getInstComponentDeclListNoTransform()) {
            ...
            return super.Define_myIndex(caller, child);
        }
    }
    /**
     * @apilevel internal
