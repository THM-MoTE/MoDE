...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:84
 * @production BaseClassDecl : {@link ClassDecl} ::= <span class="component">{@link VisibilityType}</span> <span class="component">[{@link Encapsulated}]</span> <span class="component">[{@link Partial}]</span> <span class="component">{@link Restriction}</span> <span class="component">[{@link Redeclare}]</span> <span class="component">[{@link Final}]</span> <span class="component">[{@link Inner}]</span> <span class="component">[{@link Outer}]</span> <span class="component">[{@link Replaceable}]</span> <span class="component">[{@link ConstrainingClause}]</span> <span class="component">[ConstrainingClauseComment:{@link Comment}]</span>;

 */
public abstract class BaseClassDecl extends ClassDecl implements Cloneable {
    /**
     * @aspect InstanceTreeConstruction
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1408
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1739
     */
    public Opt newInstConstrainingClassOpt(InstRedeclareClassNode cicr) {
        if (hasConstrainingClause()) {
            ...
            return new Opt(new InstConstrainingClass(cc.getAccess().newInstAccess(), opt, this, cicr));
        } else {
            return new Opt();
        }
    }
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1206
     */
    ...
    /**
     * @aspect FormattedPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1235
     */
    void prettyPrintFormattedDecl(Printer printer, CodeStream printStream) {}
    /**
     * @declaredat ASTNode:1
     */
    public BaseClassDecl() {
        super();
    }
    /**
     ...
     */
    public BaseClassDecl(IdDecl p0, VisibilityType p1, Opt<Encapsulated> p2, Opt<Partial> p3, Restriction p4, Opt<Redeclare> p5, Opt<Final> p6, Opt<Inner> p7, Opt<Outer> p8, Opt<Replaceable> p9, Opt<ConstrainingClause> p10, Opt<Comment> p11) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public BaseClassDecl clone() throws CloneNotSupportedException {
        BaseClassDecl node = (BaseClassDecl) super.clone();
        return node;
    }
    /**
     ...
     */
    public abstract BaseClassDecl fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract BaseClassDecl treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract BaseClassDecl treeCopy();
    /**
    ...
    public boolean isPartial() {
        ...
        boolean isPartial_value = hasPartial();
    ...
    public boolean isEncapsulated() {
        ASTNode$State state = state();
        boolean isEncapsulated_value = hasEncapsulated();
    ...
    public boolean isModel() {
        ASTNode$State state = state();
        boolean isModel_value = getRestriction().isModel();
    ...
    public boolean isBlock() {
        ASTNode$State state = state();
        boolean isBlock_value = getRestriction().isBlock();
    ...
    public boolean isClass() {
        ASTNode$State state = state();
        boolean isClass_value = getRestriction().isClass();
    ...
    public boolean isPackage() {
        ASTNode$State state = state();
        boolean isPackage_value = getRestriction().isPackage();
     ...
     * @attribute inh
     * @aspect Names
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/Util.jrag:651
     */
    @ASTNodeAnnotation.Attribute
