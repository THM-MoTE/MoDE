...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/InstanceTree.ast:185
 * @production InstValueRecordModification : {@link InstRecordModification} ::= <span class="component">&lt;Value:FExp&gt;</span>;

 */
public class InstValueRecordModification extends InstRecordModification implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public InstValueRecordModification() {
        super();
    }
    /**
     ...
     */
    public InstValueRecordModification(Modification p0, String p1, FExp p2) {
        setModification(p0);
        setName(p1);
        setValue(p2);
    }
     ...
     */
    public InstValueRecordModification(Modification p0, Symbol p1, FExp p2) {
        setModification(p0);
        setName(p1);
        setValue(p2);
    }
     ...
     */
    public InstValueRecordModification clone() throws CloneNotSupportedException {
        InstValueRecordModification node = (InstValueRecordModification) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public InstValueRecordModification copy() {
        try {
            InstValueRecordModification node = (InstValueRecordModification) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public InstValueRecordModification fullCopy() {
     ...
     */
    public InstValueRecordModification treeCopyNoTransform() {
        InstValueRecordModification tree = (InstValueRecordModification) copy();
        if (children != null) {
     ...
     */
    public InstValueRecordModification treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /**
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenModification_Modification == ((InstValueRecordModification)node).tokenModification_Modification) && (tokenString_Name == ((InstValueRecordModification)node).tokenString_Name) && (tokenFExp_Value == ((InstValueRecordModification)node).tokenFExp_Value);    
    }
    /**
     ...
     * @apilevel high-level
     */
    public void setValue(FExp value) {
        tokenFExp_Value = value;
    }
    /**
     * @apilevel internal
     */
    protected FExp tokenFExp_Value;
    /**
    ...
    public FExp getFExp() {
        ...
        getFExp_value = getValue().unboundCopy();
