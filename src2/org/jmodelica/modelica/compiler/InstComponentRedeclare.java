...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/InstanceTree.ast:196
...
public class InstComponentRedeclare extends InstElementRedeclare implements Cloneable {
    /**
     * @aspect ContentCheck
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/ContentsCheck.jadd:177
     */
    ...
    /**
     * @aspect ContentCheck
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/ContentsCheck.jadd:403
     */
    public void contentCheck(ErrorCheckType checkType) {}
    /**
     * @aspect InstanceErrorCheck
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/ErrorCheck.jrag:1052
     */
     ...
     */
    public InstComponentRedeclare(Modification p0, boolean p1, boolean p2, InstAccess p3) {
        setModification(p0);
        setEach(p1);
        setFinal(p2);
        setChild(p3, 0);
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenModification_Modification == ((InstComponentRedeclare)node).tokenModification_Modification) && (tokenboolean_Each == ((InstComponentRedeclare)node).tokenboolean_Each) && (tokenboolean_Final == ((InstComponentRedeclare)node).tokenboolean_Final);    
    }
    /**
    ...
    @ASTNodeAnnotation.Attribute
    public ComponentRedeclare getComponentRedeclare() {
        ASTNode$State state = state();
        ComponentRedeclare getComponentRedeclare_value = (ComponentRedeclare)    modification();

        return getComponentRedeclare_value;
    }
    /**
     * @attribute syn
     * @aspect Environments
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:379
     */
    @ASTNodeAnnotation.Attribute
    ...
    public boolean hasConstrainingModification() {
        ASTNode$State state = state();
        boolean hasConstrainingModification_value = getComponentRedeclare().getComponentDecl().hasConstrainingModification();
     ...
     * @attribute syn
     * @aspect Environments
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:683
     */
    @ASTNodeAnnotation.Attribute
    ...
    public InstComponentDecl getInstComponentDecl() {
        ...
        getInstComponentDecl_value = new InstCreateComponentDecl(getComponentRedeclare().getComponentDecl(), null);
    ...
    public Size Define_defaultSize(ASTNode caller, ASTNode child) {
        if (caller == getInstComponentDeclNoTransform()) {
            ...
            return super.Define_defaultSize(caller, child);
        }
    }
    /**
    ...
    public Size Define_defaultSizeCalc(ASTNode caller, ASTNode child) {
        if (caller == getInstComponentDeclNoTransform()) {
            ...
            return super.Define_defaultSizeCalc(caller, child);
        }
    }
    /**
