...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:204
 * @production InitialEquationClause : {@link EquationClause};

 */
public class InitialEquationClause extends EquationClause implements Cloneable {
    /**
     * @aspect FormattedPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:249
     */
    @Override
    ...
    /**
     * @aspect FormattedPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1451
     */
     ...
     */
    public InitialEquationClause(List<AbstractEquation> p0) {
        setChild(p0, 0);
    }
    /**
     * @apilevel low-level
     ...
     */
    public InitialEquationClause clone() throws CloneNotSupportedException {
        InitialEquationClause node = (InitialEquationClause) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public InitialEquationClause copy() {
        try {
            InitialEquationClause node = (InitialEquationClause) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public InitialEquationClause fullCopy() {
     ...
     */
    public InitialEquationClause treeCopyNoTransform() {
        InitialEquationClause tree = (InitialEquationClause) copy();
        if (children != null) {
     ...
     */
    public InitialEquationClause treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /**
