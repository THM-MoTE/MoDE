...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/InstanceTree.ast:148
...
public class InstInlineExtends extends InstNormalExtends implements Cloneable {
     ...
     */
    public InstInlineExtends(InstAccess p0, ExtendsClause p1, Opt<InstClassModification> p2) {
        setChild(p0, 0);
        setExtendsClause(p1);
        setChild(p2, 1);
    }
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenExtendsClause_ExtendsClause == ((InstInlineExtends)node).tokenExtendsClause_ExtendsClause);    
    }
    /**
