 ...
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/Annotations.jrag:960
 */
public class ComponentModAnnotationNode extends ExpAnnotationNode {
		...
		public Iterator<AnnotationNode> attributeIterator() {
			if (mod.hasModification())
				return mod.getModification().annotationNode().attributeIterator();
			else
