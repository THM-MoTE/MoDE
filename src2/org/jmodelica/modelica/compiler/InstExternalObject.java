...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/InstanceTree.ast:114
 * @production InstExternalObject : {@link InstPrimitive} ::= <span class="component">DestructorCall:{@link FFunctionCallStmt}</span>;

 */
public class InstExternalObject extends InstPrimitive implements Cloneable {
    /**
     * @aspect ForceVariability
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/ContentsCheck.jadd:808
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/ErrorCheck.jrag:1196
     */
    public void collectErrors(ErrorCheckType checkType) {
	    if (!errorChecked) {
	    	...
	    	if (!inFunction()) {
                if (!hasBindingExp()) {
                    error("Missing binding expression for external object");
                }
    ...
    /**
     * @aspect Flattening
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Flattening.jrag:208
     */
    ...
    /**
     * @aspect Flattening
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Flattening.jrag:1146
     */
     ...
     */
    public InstExternalObject(InstAccess p0, Opt<FArraySubscripts> p1, ComponentDecl p2, Opt<InstModification> p3, Opt<InstConstrainingComponent> p4, Opt<FExp> p5) {
        setChild(p0, 0);
        setChild(p1, 1);
        setComponentDecl(p2);
        setChild(p3, 2);
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenComponentDecl_ComponentDecl == ((InstExternalObject)node).tokenComponentDecl_ComponentDecl);    
    }
    /**
    ...
    public FFunctionCallStmt getDestructorCallNoTransform() {
        return (FFunctionCallStmt) getChildNoTransform(17);
    }
    /**
    ...
    public FTypePrefixVariability calcVariability() {
        ASTNode$State state = state();
        FTypePrefixVariability calcVariability_value = fParameter();
    ...
    private FFunctionCallStmt getDestructorCall_compute() {
    		...
    		args.add(new InstPositionalArgument(createUseExp(), 0));
    ...
    public InstLookupResult<InstClassDecl> Define_lookupInstClass(ASTNode caller, ASTNode child, String name) {
        if (caller == getDestructorCallNoTransform()) {
