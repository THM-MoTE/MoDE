...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/InstanceTree.ast:125
 * @production InstReplacingRecord : {@link InstRecord} ::= <span class="component">&lt;OriginalDecl:ComponentDecl&gt;</span> <span class="component">OriginalInstComponent:{@link InstComponentDecl}</span> <span class="component">&lt;InstComponentRedeclare:InstComponentRedeclare&gt;</span>;

 */
public class InstReplacingRecord extends InstRecord implements Cloneable {
    /**
     * @aspect InstanceErrorCheck
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/ErrorCheck.jrag:1068
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/TypeCheck.jrag:69
     */
    ...
    /**
     * @aspect InstArrays
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:2512
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:2706
     */
     ...
     */
    public InstReplacingRecord(InstAccess p0, Opt<FArraySubscripts> p1, ComponentDecl p2, Opt<InstModification> p3, Opt<InstConstrainingComponent> p4, Opt<FExp> p5, ComponentDecl p6, InstComponentRedeclare p7) {
        setChild(p0, 0);
        setChild(p1, 1);
        setComponentDecl(p2);
        setChild(p3, 2);
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenComponentDecl_ComponentDecl == ((InstReplacingRecord)node).tokenComponentDecl_ComponentDecl) && (tokenComponentDecl_OriginalDecl == ((InstReplacingRecord)node).tokenComponentDecl_OriginalDecl) && (tokenInstComponentRedeclare_InstComponentRedeclare == ((InstReplacingRecord)node).tokenInstComponentRedeclare_InstComponentRedeclare);    
    }
    /**
     ...
     * @apilevel high-level
     */
    public void setOriginalDecl(ComponentDecl value) {
        tokenComponentDecl_OriginalDecl = value;
    }
    /**
     * @apilevel internal
     */
    protected ComponentDecl tokenComponentDecl_OriginalDecl;
    /**
    ...
    public ComponentDecl getOriginalDecl() {
        return tokenComponentDecl_OriginalDecl;
    }
    /**
    ...
    public InstComponentDecl getOriginalInstComponentNoTransform() {
        return (InstComponentDecl) getChildNoTransform(17);
    }
    /**
    ...
    public FTypePrefixVariability noDefinedVariability() {
        ASTNode$State state = state();
        FTypePrefixVariability noDefinedVariability_value = getOriginalInstComponent().localDefinedVariability();
    ...
    public boolean isComponentDeclaredInput() {
        ASTNode$State state = state();
        boolean isComponentDeclaredInput_value = getComponentDecl().hasTypePrefixInputOutput() ? getComponentDecl().isInput() : getOriginalInstComponent().isDeclaredInput();
    ...
    public boolean isDeclaredFlow() {
        ASTNode$State state = state();
        boolean isDeclaredFlow_value = getComponentDecl().hasFlowOrStream() ? getComponentDecl().isFlow() : getOriginalDecl().isFlow();
    ...
    public boolean isStream() {
        ASTNode$State state = state();
        boolean isStream_value = getComponentDecl().hasFlowOrStream() ? getComponentDecl().isStream() : getOriginalDecl().isStream();
    ...
    public boolean isInner() {
        ASTNode$State state = state();
        boolean isInner_value = getComponentDecl().hasInnerOrOuter() ? getComponentDecl().isInner() : getOriginalDecl().isInner();
    ...
    public boolean isOuter() {
        ASTNode$State state = state();
        boolean isOuter_value = getComponentDecl().hasInnerOrOuter() ? getComponentDecl().isOuter() : getOriginalDecl().isOuter();
    ...
    public FQName Define_retrieveFQName(ASTNode caller, ASTNode child) {
        if (caller == getOriginalInstComponentNoTransform()) {
    ...
    public InstLookupResult<InstClassDecl> Define_lookupInstClass(ASTNode caller, ASTNode child, String name) {
        ...
        else if (caller == getOriginalInstComponentNoTransform()) {
