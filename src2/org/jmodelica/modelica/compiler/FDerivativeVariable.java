 ...
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/ast/FlatModelica.ast:285
...
public class FDerivativeVariable extends FAbstractDerivativeVariable implements Cloneable {
     ...
     * @aspect Constructors
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/Constructors.jrag:638
     */
    public FDerivativeVariable(FVisibilityType fvt, 
    ...
    /**
     * @aspect FlatNames
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/FlatUtil.jrag:1072
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/TransformCanonical.jrag:1682
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/TransformCanonical.jrag:3006
     */
    ...
    /**
     * @aspect DummyDerivatives
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/TransformCanonical.jrag:3011
     */
     ...
     */
    public FDerivativeVariable(FVisibilityType p0, FTypePrefixVariability p1, Opt<FTypePrefixInputOutput> p2, List<FAttribute> p3, String p4, Opt<FExp> p5, Opt<FStringComment> p6, FQName p7, int p8) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public FDerivativeVariable(FVisibilityType p0, FTypePrefixVariability p1, Opt<FTypePrefixInputOutput> p2, List<FAttribute> p3, Symbol p4, Opt<FExp> p5, Opt<FStringComment> p6, FQName p7, int p8) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_DerivedType == ((FDerivativeVariable)node).tokenString_DerivedType) && (tokenint_Order == ((FDerivativeVariable)node).tokenint_Order);    
    }
    /**
    ...
    public boolean shouldContributeFiltered() {
        ...
        boolean shouldContributeFiltered_value = shouldContribute() && (myDifferentiatedVariable().stateSelectAttributeSet() || uses().size() > 0);
    ...
    public boolean nominalAttributeSet() {
        ASTNode$State state = state();
        boolean nominalAttributeSet_value = myDifferentiatedVariable().nominalAttributeSet();
    ...
    public FExp nominalAttributeExp() {
        ASTNode$State state = state();
        FExp nominalAttributeExp_value = myDifferentiatedVariable().nominalAttributeExp();
    ...
    public CValue nominalAttributeCValue() {
        ASTNode$State state = state();
        CValue nominalAttributeCValue_value = myDifferentiatedVariable().nominalAttributeCValue();
     ...
     * @attribute coll
     * @aspect FlatAPI
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/FlatAPI.jrag:673
     */
        if ((shouldContribute())) {
            {
     ...
     * @attribute coll
     * @aspect FlatAPI
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/FlatAPI.jrag:737
     */
     ...
     * @attribute coll
     * @aspect FlatAPI
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/FlatAPI.jrag:787
     */
        if ((shouldContribute())) {
            {
                FClass ref = (FClass) (myFClass());
                if (ref != null) {
                    ref.FClass_derivativeVariables_contributors().add(this);
                }
            }
        }
    ...
    protected void contributeTo_FClass_FClass_allDifferentiatedRealVariables(LinkedHashSet<FRealVariable> collection) {
        ...
        if ((shouldContribute()))
            collection.add(myDifferentiatedVariable());
    }
    ...
    protected void contributeTo_FClass_FClass_derivativeVariables(ArrayList<FDerivativeVariable> collection) {
        super.contributeTo_FClass_FClass_derivativeVariables(collection);
        if ((shouldContribute()))
            collection.add(this);
    }
