...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:293
 * @production ElementRedeclare : {@link NamedModification};

 */
public abstract class ElementRedeclare extends NamedModification implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public ElementRedeclare() {
        super();
    }
    /**
     ...
     */
    public ElementRedeclare(Opt<Each> p0, Opt<Final> p1, Access p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
     ...
     */
    public ElementRedeclare clone() throws CloneNotSupportedException {
        ElementRedeclare node = (ElementRedeclare) super.clone();
        return node;
    }
    /**
     ...
     */
    public abstract ElementRedeclare fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract ElementRedeclare treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract ElementRedeclare treeCopy();
    /**
