...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:143
 * @production PrimitiveClassDecl : {@link FullClassDecl};

 */
public class PrimitiveClassDecl extends FullClassDecl implements Cloneable {
    /**
     * @aspect InstanceTreeConstruction
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1344
     */
    ...
    /**
     * @aspect InstanceTreeConstruction
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1368
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/PredefinedTypes.jrag:603
     */
    boolean rewritten = false;
    /**
     * @declaredat ASTNode:1
     */
    public PrimitiveClassDecl() {
        super();
    }
    /**
     ...
     */
    public PrimitiveClassDecl clone() throws CloneNotSupportedException {
        PrimitiveClassDecl node = (PrimitiveClassDecl) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public PrimitiveClassDecl copy() {
        try {
            PrimitiveClassDecl node = (PrimitiveClassDecl) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public PrimitiveClassDecl fullCopy() {
     ...
     */
    public PrimitiveClassDecl treeCopyNoTransform() {
        PrimitiveClassDecl tree = (PrimitiveClassDecl) copy();
        if (children != null) {
     ...
     */
    public PrimitiveClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /**
    ...
    public ASTNode rewriteTo() {
        // Declared at @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/PredefinedTypes.jrag:605
        if (getName().getID().equals("Real") && !rewritten) {
            state().duringPredefinedTypes++;
            ASTNode result = rewriteRule0();
            state().duringPredefinedTypes--;
            return result;
        }
        // Declared at @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/PredefinedTypes.jrag:637
        if (getName().getID().equals("Integer") && !rewritten) {
            state().duringPredefinedTypes++;
            ASTNode result = rewriteRule1();
            state().duringPredefinedTypes--;
            return result;
        }
        // Declared at @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/PredefinedTypes.jrag:669
        if (getName().getID().equals("Boolean") && !rewritten) {
            state().duringPredefinedTypes++;
            ASTNode result = rewriteRule2();
            state().duringPredefinedTypes--;
            return result;
        }
        // Declared at @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/PredefinedTypes.jrag:701
        if (getName().getID().equals("String") && !rewritten) {
            state().duringPredefinedTypes++;
    ...
    /**
     * @declaredat @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/PredefinedTypes.jrag:605
     * @apilevel internal
     */
    private RealClassDecl rewriteRule0() {
{
    ...
    /**
     * @declaredat @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/PredefinedTypes.jrag:637
     * @apilevel internal
     */
    private IntegerClassDecl rewriteRule1() {
{
    ...
    /**
     * @declaredat @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/PredefinedTypes.jrag:669
     * @apilevel internal
     */
    private BooleanClassDecl rewriteRule2() {
{
    ...
    /**
     * @declaredat @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/PredefinedTypes.jrag:701
     * @apilevel internal
     */
    private StringClassDecl rewriteRule3() {
{
