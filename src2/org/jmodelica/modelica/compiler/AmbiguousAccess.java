...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:399
 * @production AmbiguousAccess : {@link ArrayAccess};

 */
public class AmbiguousAccess extends ArrayAccess implements Cloneable {
    /**
     ...
     */
    public AmbiguousAccess(String p0, Opt<ArraySubscripts> p1) {
        setID(p0);
        setChild(p1, 0);
    }
    /**
     ...
     */
    public AmbiguousAccess(Symbol p0, Opt<ArraySubscripts> p1) {
        setID(p0);
        setChild(p1, 0);
    }
    /**
