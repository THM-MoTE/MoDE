...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:289
 * @production NamedModification : {@link Argument} ::= <span class="component">Name:{@link Access}</span>;

 */
public abstract class NamedModification extends Argument implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public NamedModification() {
        super();
    }
    /**
     ...
     */
    public NamedModification(Opt<Each> p0, Opt<Final> p1, Access p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
     ...
     */
    public NamedModification clone() throws CloneNotSupportedException {
        NamedModification node = (NamedModification) super.clone();
        return node;
    }
    /**
     ...
     */
    public abstract NamedModification fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract NamedModification treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract NamedModification treeCopy();
    /**
