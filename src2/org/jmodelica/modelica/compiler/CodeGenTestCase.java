...
/**
 * @ast class
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/TestFramework/src/jastadd/CodeGenTestCase.jrag:26
 */
public abstract class CodeGenTestCase extends TestCase {
    ...
    protected  boolean testTransformed(FClass fc) {
        ...
        PrintStream ps;
        if (options.getBooleanOption("debug_duplicate_generated")) {
        ...
        generator.generate(createTemplateReader(), new NotNullCodeStream(ps));
