 ...
 * by the compiler.
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/ast/FlatModelica.ast:296
...
public class FDynamicDerivativeVariable extends FAbstractDerivativeVariable implements Cloneable {
    /**
     * @aspect FlatNames
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/FlatUtil.jrag:1080
     */
     ...
     */
    public FDynamicDerivativeVariable(FVisibilityType p0, FTypePrefixVariability p1, Opt<FTypePrefixInputOutput> p2, List<FAttribute> p3, String p4, Opt<FExp> p5, Opt<FStringComment> p6, FQName p7, int p8, DynamicStateSet p9) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public FDynamicDerivativeVariable(FVisibilityType p0, FTypePrefixVariability p1, Opt<FTypePrefixInputOutput> p2, List<FAttribute> p3, Symbol p4, Opt<FExp> p5, Opt<FStringComment> p6, FQName p7, int p8, DynamicStateSet p9) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_DerivedType == ((FDynamicDerivativeVariable)node).tokenString_DerivedType) && (tokenint_Order == ((FDynamicDerivativeVariable)node).tokenint_Order) && (tokenDynamicStateSet_Set == ((FDynamicDerivativeVariable)node).tokenDynamicStateSet_Set);    
    }
    /**
    ...
    public String dynDerName() {
        ASTNode$State state = state();
        String dynDerName_value = getFQName().dynDerName(order());
     ...
     * @attribute coll
     * @aspect FlatAPI
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/FlatAPI.jrag:676
     */
        if ((shouldContribute())) {
            {
