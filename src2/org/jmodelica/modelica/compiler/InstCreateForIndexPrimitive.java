...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/InstanceTree.ast:134
...
public class InstCreateForIndexPrimitive extends InstPrimitive implements Cloneable {
     ...
     */
    public InstCreateForIndexPrimitive(InstAccess p0, Opt<FArraySubscripts> p1, ComponentDecl p2, Opt<InstModification> p3, Opt<InstConstrainingComponent> p4, Opt<FExp> p5, InstLookupRedirectNode p6) {
        setChild(p0, 0);
        setChild(p1, 1);
        setComponentDecl(p2);
        setChild(p3, 2);
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenComponentDecl_ComponentDecl == ((InstCreateForIndexPrimitive)node).tokenComponentDecl_ComponentDecl) && (tokenInstLookupRedirectNode_LookupNode == ((InstCreateForIndexPrimitive)node).tokenInstLookupRedirectNode_LookupNode);    
    }
    /**
    ...
    public ASTNode rewriteTo() {
        // Declared at @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1084
    ...
    /**
     * @declaredat @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1084
     * @apilevel internal
     */    private InstPrimitive rewriteRule0() {
        return (InstPrimitive) getClassName().myInstClassDecl().newInstComponentDecl(getComponentDecl());
    }
}
