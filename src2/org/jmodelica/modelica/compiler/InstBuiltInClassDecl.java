...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/InstanceTree.ast:52
...
public class InstBuiltInClassDecl extends InstClassDecl implements Cloneable {
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1198
     */
    ...
    /**
     * @aspect InstanceTreeConstruction
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1246
     */
    ...
    /**
     * @aspect InstanceTreeConstruction
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1303
     */
     ...
     */
    public InstBuiltInClassDecl(ClassDecl p0) {
        setClassDecl(p0);
    }
    /**
     * @apilevel low-level
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenClassDecl_ClassDecl == ((InstBuiltInClassDecl)node).tokenClassDecl_ClassDecl);    
    }
    /**
    ...
    public String name() {
        ASTNode$State state = state();
        String name_value = getBuiltInClassDecl().name();

        return name_value;
    }
    @ASTNodeAnnotation.Attribute
    public BuiltInClassDecl getBuiltInClassDecl() {
        ASTNode$State state = state();
        BuiltInClassDecl getBuiltInClassDecl_value = (BuiltInClassDecl)getClassDecl();

        return getBuiltInClassDecl_value;
    }
    /**
     * @apilevel internal
     */
