 ...
 * @ast class
 * @aspect CADCodeGen
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaCBackEnd/src/jastadd/CADCodeGen.jrag:36
 */
public class CADPrettyPrinter extends CodePrinter {
    

        public CADPrettyPrinter() {
            this(false, false, Homotopy.HOMOTOPY, true);
        }

    

        private CADPrettyPrinter(boolean inBlock, boolean inInitialSystem, Homotopy homotopyType, 
                boolean writeSwitches) {
            super(inBlock, inInitialSystem, homotopyType, writeSwitches);
        }

    

        @Override
        protected CodePrinter createPrinter(boolean inBlock, boolean inInitialSystem, Homotopy homotopyType,
                boolean writeSwitches) {
            return new CADPrettyPrinter(inBlock, inInitialSystem, homotopyType, writeSwitches);
        }
        ...
        @Override
        public void printWriteBackAssignment(CodeStream str, String indent, FFunctionCallLeft left,
        ...
        public class WriteBackAssignmentPrinter_var extends WriteBackAssignmentPrinter {
        ...
        public class WriteBackAssignmentPrinter_der extends WriteBackAssignmentPrinter {
        ...
        public class WriteBackResidualPrinter_var extends WriteBackResidualPrinter {
        ...
        public class WriteBackResidualPrinter_der extends WriteBackResidualPrinter {
