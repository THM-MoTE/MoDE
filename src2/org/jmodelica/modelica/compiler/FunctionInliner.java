 ...
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/optimizations/InlineFunctions.jrag:375
 */
public class FunctionInliner extends AbstractFunctionInliner {
        ...
        private List<FAbstractEquation> initialEqns;
        ...
        public FunctionInliner(FClass fc, String level, boolean late) {
            ...
            initialEqns = fc.getFInitialEquations();
         ...
         */
        public void inline() {
            List<FAbstractEquation> oldInitialEqns = initialEqns;
            initialEqns = new List<FAbstractEquation>();
            fc.setFInitialEquationList(initialEqns);
            setContextVariability(ASTNode.fInitialParameter());
            inlineFCList(oldInitialEqns, initialEqns);
            
            List<FAbstractEquation> oldNormalEqns = normalEqns;
            normalEqns = new List<FAbstractEquation>();
            fc.setFAbstractEquationList(normalEqns);
            setContextVariability(ASTNode.fContinuous());
            inlineFCList(oldNormalEqns, normalEqns);
            
            List<FAbstractEquation> oldParamEqns = paramEqns;
            paramEqns = new List<FAbstractEquation>();
            fc.setFParameterEquationList(paramEqns);
            setContextVariability(ASTNode.fParameter());
            inlineFCList(oldParamEqns, paramEqns);
        }
