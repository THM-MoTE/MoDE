...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/InstanceTree.ast:68
...
public class InstReplacingPrimitiveClassDecl extends InstReplacingFullClassDecl implements Cloneable {
     ...
     */
    public InstReplacingPrimitiveClassDecl(ClassDecl p0, Opt<InstConstrainingClass> p1, InstRestriction p2, Opt<InstExternal> p3, ClassDecl p4, InstRedeclareClassNode p5) {
        setClassDecl(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setChild(p3, 2);
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenClassDecl_ClassDecl == ((InstReplacingPrimitiveClassDecl)node).tokenClassDecl_ClassDecl) && (tokenClassDecl_OriginalClassDecl == ((InstReplacingPrimitiveClassDecl)node).tokenClassDecl_OriginalClassDecl) && (tokenInstRedeclareClassNode_InstClassRedeclare == ((InstReplacingPrimitiveClassDecl)node).tokenInstRedeclareClassNode_InstClassRedeclare);    
    }
    /**
