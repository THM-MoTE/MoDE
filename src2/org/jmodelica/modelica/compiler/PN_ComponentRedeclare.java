...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:295
 * @production PN_ComponentRedeclare : {@link ElementRedeclare} ::= <span class="component">{@link BaseComponentDecl}</span>;

 */
public class PN_ComponentRedeclare extends ElementRedeclare implements Cloneable {
    /**
     * @aspect InstModifications
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:254
     */
     ...
     */
    public PN_ComponentRedeclare(Opt<Each> p0, Opt<Final> p1, Access p2, BaseComponentDecl p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public PN_ComponentRedeclare clone() throws CloneNotSupportedException {
        PN_ComponentRedeclare node = (PN_ComponentRedeclare) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public PN_ComponentRedeclare copy() {
        try {
            PN_ComponentRedeclare node = (PN_ComponentRedeclare) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public PN_ComponentRedeclare fullCopy() {
     ...
     */
    public PN_ComponentRedeclare treeCopyNoTransform() {
        PN_ComponentRedeclare tree = (PN_ComponentRedeclare) copy();
        if (children != null) {
     ...
     */
    public PN_ComponentRedeclare treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /**
    ...
    /**
     * Replaces the BaseComponentDecl child.
     * @param node The new node to replace the BaseComponentDecl child.
     * @apilevel high-level
     */
    public void setBaseComponentDecl(BaseComponentDecl node) {
        setChild(node, 3);
    }
    /**
     * Retrieves the BaseComponentDecl child.
     * @return The current node used as the BaseComponentDecl child.
     * @apilevel high-level
     */
    @ASTNodeAnnotation.Child(name="BaseComponentDecl")
    public BaseComponentDecl getBaseComponentDecl() {
        return (BaseComponentDecl) getChild(3);
    }
    /**
     * Retrieves the BaseComponentDecl child.
     * <p><em>This method does not invoke AST transformations.</em></p>
     ...
     * @apilevel low-level
     */
    public BaseComponentDecl getBaseComponentDeclNoTransform() {
        return (BaseComponentDecl) getChildNoTransform(3);
    }
    /**
     * @apilevel internal
     */
    public ASTNode rewriteTo() {
        // Declared at @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/InitialTransformations.jrag:314
    ...
    /**
     * @declaredat @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/InitialTransformations.jrag:314
     * @apilevel internal
     */
    private ComponentRedeclare rewriteRule0() {
{
