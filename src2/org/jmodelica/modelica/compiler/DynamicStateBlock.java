 ...
 * @ast class
 * @aspect BLT
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/structural/BLT.jrag:1943
 */
public class DynamicStateBlock extends AbstractSubBLTBlock<DynamicStateBLT> {
    ...
    public void genBlock_C(CodePrinter p, CodeStream str, String indent, boolean inInitial) {
        ...
        for (DynamicStateBLT blt : subBLTs()) {
            ...
            first = false;
            blt.genSubBLTTest_C(p, str);
            str.println(") {");
            blt.genVarDecls_C(p, str, innerIndent);
