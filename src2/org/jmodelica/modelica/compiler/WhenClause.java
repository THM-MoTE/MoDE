...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:335
 * @production WhenClause : {@link IfWhenClause};

 */
public class WhenClause extends IfWhenClause implements Cloneable {
    /**
     * @aspect InstantiatedExpressions
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Flattening.jrag:3001
     */
     ...
     */
    public WhenClause(Exp p0, List<Statement> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /**
     ...
     */
    public WhenClause clone() throws CloneNotSupportedException {
        WhenClause node = (WhenClause) super.clone();
        return node;
    }
    /**
     * @apilevel internal
    ...
    public WhenClause copy() {
        try {
            WhenClause node = (WhenClause) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public WhenClause treeCopyNoTransform() {
        WhenClause tree = (WhenClause) copy();
        if (children != null) {
