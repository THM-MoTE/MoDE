 ...
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/ast/FlatModelica.ast:751
 * @production FInitArrayStmt : {@link FStatement} ::= <span class="component">{@link FIdUseExp}</span>;

 */
public class FInitArrayStmt extends FStatement implements Cloneable {
    /**
     * @aspect ConstantEvaluation
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/ConstantEvaluation.jrag:4230
     */
    @Override
  public int evaluate(AlgorithmEvaluator evaluator) {
        getFIdUseExp().assignToInFuncEval(evaluator, type().zeroCValue());
	  return EVAL_CONT;
  }
    /**
     * @aspect FlatPrettyPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/PrettyPrint.jrag:1462
     */
    public void prettyPrint(Printer p, CodeStream str, String indent) {
        ...
        if (type().isArray()) {
            str.print("[");
            str.print(type().size().toUnclosedString());
            str.print("]");
        }
	}
    /**
     * @aspect FlatStatements
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/FlatteningStatements.jrag:68
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/optimizations/InlineFunctions.jrag:1345
     */
    public void inline(AbstractFunctionInliner fi) {
        ...
        t.setParent(getFIdUseExp());
        fi.setTypeOf(fv.name(), t);
        fv.flushCache();
    }
    /**
     * @aspect AlgorithmScalarization
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/scalarization/ScalarizeAlgorithms.jrag:136
     */
    @Override
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/structural/Differentiation.jrag:945
     */
    @Override
    ...
    /**
     * @aspect CADCodeGen
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaCBackEnd/src/jastadd/CADCodeGen.jrag:2315
     */
    @Override
    public void prettyPrint_CAD(CodePrinter p, CodeStream str, String indent) {
        FFunctionVariable fv = getFIdUseExp().myFuncVar();
        FInitArrayStmt.genInit_C(p, str, indent, fv.varName_CAD(), fv, type());
        FInitArrayStmt.genInit_C(p, str, indent, fv.derName_CAD(), fv, type());
    }
    /**
     * @aspect CCodeGen
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaCBackEnd/src/jastadd/CCodeGen.jrag:1764
     */
    @Override
    ...
    /**
     * @aspect CCodeGen
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaCBackEnd/src/jastadd/CCodeGen.jrag:1770
     */
    public static void genInit_C(CodePrinter p, CodeStream str, String indent, String name,
        ...
        if (fv.isComposite() && fv.isOutput() && !fv.isString()) {
            ...
            tp.reset(iniName, fv.getBindingExp(), type.size().isUnknown(), false, next);
            type.print(tp);
            str.print(next + name + " = " + iniName + ";\n");
            str.print(indent + "}\n");
        } else {
            tp.reset(name, fv.getBindingExp(), type.size().isUnknown(), false, indent);
            type.print(tp);
        }
        fv.resetDummyExp();
    }
     ...
     */
    public FInitArrayStmt(FIdUseExp p0) {
        setChild(p0, 0);
    }
    /**
     * @apilevel low-level
    ...
    /**
     * Replaces the FIdUseExp child.
     * @param node The new node to replace the FIdUseExp child.
     * @apilevel high-level
     */
    public void setFIdUseExp(FIdUseExp node) {
        setChild(node, 0);
    }
    /**
     * Retrieves the FIdUseExp child.
     * @return The current node used as the FIdUseExp child.
     * @apilevel high-level
     */
    @ASTNodeAnnotation.Child(name="FIdUseExp")
    public FIdUseExp getFIdUseExp() {
     ...
     * @apilevel low-level
     */
    public FIdUseExp getFIdUseExpNoTransform() {
    ...
    public FType getType() {
        ASTNode$State state = state();
        FType getType_value = getFIdUseExp().myFV().type();
    ...
    public Set<String> sortingAssignedNames() {
        ...
        int num = state.boundariesCrossed;
        boolean isFinal = this.is$Final();
        sortingAssignedNames_value = Collections.singleton("size(" + getFIdUseExp().name() + ")");
        if (isFinal && num == state().boundariesCrossed) {
