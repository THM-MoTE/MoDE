...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:148
 * @production EnumClassDecl : {@link PrimitiveClassDecl} ::= <span class="component">&lt;Symbol:Symbol&gt;</span>;

 */
public class EnumClassDecl extends PrimitiveClassDecl implements Cloneable {
    /**
     * @aspect InstanceTreeConstruction
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1352
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:274
     */
    @Override
    ...
    /**
     * @aspect FormattedPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1273
     */
     ...
     */
    public EnumClassDecl(IdDecl p0, VisibilityType p1, Opt<Encapsulated> p2, Opt<Partial> p3, Restriction p4, Opt<Redeclare> p5, Opt<Final> p6, Opt<Inner> p7, Opt<Outer> p8, Opt<Replaceable> p9, Opt<ConstrainingClause> p10, Opt<Comment> p11, Opt<StringComment> p12, List<AbstractEquation> p13, List<Algorithm> p14, List<ExtendsClause> p15, List<ImportClause> p16, List<ClassDecl> p17, List<ComponentDecl> p18, List<Modification> p19, Opt<ExternalClause> p20, Opt<Annotation> p21, EndDecl p22, Symbol p23) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public EnumClassDecl clone() throws CloneNotSupportedException {
        EnumClassDecl node = (EnumClassDecl) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public EnumClassDecl copy() {
        try {
            EnumClassDecl node = (EnumClassDecl) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public EnumClassDecl treeCopyNoTransform() {
        EnumClassDecl tree = (EnumClassDecl) copy();
        if (children != null) {
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenSymbol_Symbol == ((EnumClassDecl)node).tokenSymbol_Symbol);    
    }
    /**
    ...
    public boolean Define_shouldNotBeFormatted(ASTNode caller, ASTNode child) {
        if (caller == getComponentDeclListNoTransform()) {
            int i = caller.getIndexOfChild(child);
            return !getComponentDecl(i).isEnumLiteral();
        }
        else {
