...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/InstanceTree.ast:45
...
public class InstFullClassDecl extends InstBaseClassDecl implements Cloneable {
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/ErrorCheck.jrag:676
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:2760
     */
     ...
     */
    public InstFullClassDecl(ClassDecl p0, Opt<InstConstrainingClass> p1, InstRestriction p2, Opt<InstExternal> p3) {
        setClassDecl(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setChild(p3, 2);
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenClassDecl_ClassDecl == ((InstFullClassDecl)node).tokenClassDecl_ClassDecl);    
    }
    /**
    ...
    public FullClassDecl getFullClassDecl() {
        ASTNode$State state = state();
        FullClassDecl getFullClassDecl_value = (FullClassDecl)getClassDecl();

        return getFullClassDecl_value;
    }
    @ASTNodeAnnotation.Attribute
    public Iterable<AbstractEquation> equations() {
        ASTNode$State state = state();
        Iterable<AbstractEquation> equations_value = getBaseClassDecl().equations();
    ...
    public Iterable<Algorithm> algorithms() {
        ASTNode$State state = state();
        Iterable<Algorithm> algorithms_value = getBaseClassDecl().algorithms();
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1892
     */
    @ASTNodeAnnotation.Attribute
    ...
    public java.util.List<FSubscript> myFSubscripts() {
        ASTNode$State state = state();
        java.util.List<FSubscript> myFSubscripts_value = (getNumInstExtends() == 1) ? getInstExtends(0).myFSubscripts() : super.myFSubscripts();
