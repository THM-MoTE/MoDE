 ...
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/ast/FlatModelica.ast:693
...
public class FElseEquation extends FIfWhenElseEquation implements Cloneable {
     ...
     * @aspect Constructors
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/Constructors.jrag:91
     */
    public FElseEquation(FEquationType type, List<FAbstractEquation> eqns) {
		this(type, new List<FAttribute>(), eqns);
	}
    /**
     * @aspect InheritedFactoryMethods
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/Constructors.jrag:1394
     */
    public FElseEquation createEmptyNode() { return new FElseEquation(); }
    /**
     * @aspect CCodeGen
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaCBackEnd/src/jastadd/CCodeGen.jrag:1825
     */
    @Override
     ...
     */
    public FElseEquation(FEquationType p0, List<FAttribute> p1, List<FAbstractEquation> p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
    ...
    public ASTNode rewriteTo() {
        // Declared at @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/TransformCanonical.jrag:2439
        if (getParent().getParent() instanceof FClass &&
                ((FClass)getParent().getParent()).getFInitialEquationListNoTransform() == getParent() && getNumFAbstractEquation() > 0) {

            state().duringIfEquations++;
            List list = (List) getParent();
            int i = list.getIndexOfChild(this);
            List newList = rewriteFClass_getFInitialEquation();
        ...
        // Declared at @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/TransformCanonical.jrag:2443
        if (getParent().getParent() instanceof FClass &&
                ((FClass)getParent().getParent()).getFParameterEquationListNoTransform() == getParent() && getNumFAbstractEquation() > 0) {

            state().duringIfEquations++;
            List list = (List) getParent();
            int i = list.getIndexOfChild(this);
            List newList = rewriteFClass_getFParameterEquation();
            // the first child is set by the normal rewrite loop
            //list.setChild(newList.getChildNoTransform(0), i);
            for(int j = 1; j < newList.getNumChildNoTransform(); j++)
                list.insertChild(newList.getChildNoTransform(j), ++i);
        ...
        // Declared at @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/TransformCanonical.jrag:2447
        if (getParent().getParent() instanceof FClass &&
                ((FClass)getParent().getParent()).getFAbstractEquationListNoTransform() == getParent() && getNumFAbstractEquation() > 0) {

            state().duringIfEquations++;
            List list = (List) getParent();
            int i = list.getIndexOfChild(this);
            List newList = rewriteFClass_getFAbstractEquation();
            // the first child is set by the normal rewrite loop
            //list.setChild(newList.getChildNoTransform(0), i);
            for(int j = 1; j < newList.getNumChildNoTransform(); j++)
                list.insertChild(newList.getChildNoTransform(j), ++i);
        ...
        // Declared at @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/TransformCanonical.jrag:2451
        if (getParent().getParent() instanceof FIfWhenElseEquation &&
                ((FIfWhenElseEquation)getParent().getParent()).getFAbstractEquationListNoTransform() == getParent() && getNumFAbstractEquation() > 0) {

            state().duringIfEquations++;
            List list = (List) getParent();
            int i = list.getIndexOfChild(this);
            List newList = rewriteFIfWhenElseEquation_getFAbstractEquation();
            // the first child is set by the normal rewrite loop
            //list.setChild(newList.getChildNoTransform(0), i);
            for(int j = 1; j < newList.getNumChildNoTransform(); j++)
                list.insertChild(newList.getChildNoTransform(j), ++i);
        ...
        // Declared at @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/TransformCanonical.jrag:2455
        if (getParent().getParent() instanceof FForClauseE &&
                ((FForClauseE)getParent().getParent()).getFAbstractEquationListNoTransform() == getParent() && getNumFAbstractEquation() > 0) {

            state().duringIfEquations++;
            List list = (List) getParent();
            int i = list.getIndexOfChild(this);
            List newList = rewriteFForClauseE_getFAbstractEquation();
            // the first child is set by the normal rewrite loop
            //list.setChild(newList.getChildNoTransform(0), i);
            for(int j = 1; j < newList.getNumChildNoTransform(); j++)
                list.insertChild(newList.getChildNoTransform(j), ++i);
    ...
    /**
     * @declaredat @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/TransformCanonical.jrag:2439
     * @apilevel internal
     */    private List rewriteFClass_getFInitialEquation() {
        return getFAbstractEquations();
    }
    /**
     * @declaredat @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/TransformCanonical.jrag:2443
     * @apilevel internal
     */    private List rewriteFClass_getFParameterEquation() {
        return getFAbstractEquations();
    }
    /**
     * @declaredat @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/TransformCanonical.jrag:2447
     * @apilevel internal
     */    private List rewriteFClass_getFAbstractEquation() {
        return getFAbstractEquations();
    }
    /**
     * @declaredat @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/TransformCanonical.jrag:2451
     * @apilevel internal
     */    private List rewriteFIfWhenElseEquation_getFAbstractEquation() {
        return getFAbstractEquations();
    }
    /**
     * @declaredat @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/TransformCanonical.jrag:2455
     * @apilevel internal
     */    private List rewriteFForClauseE_getFAbstractEquation() {
        return getFAbstractEquations();
    }
}
