...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:210
 * @production InlineExtendsClause : {@link ExtendsClause};

 */
public class InlineExtendsClause extends ExtendsClause implements Cloneable {
    /**
     * @aspect InstanceTreeConstruction
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1484
     */
     ...
     */
    public InlineExtendsClause(VisibilityType p0, Access p1, Opt<ClassModification> p2, Opt<Annotation> p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public InlineExtendsClause clone() throws CloneNotSupportedException {
        InlineExtendsClause node = (InlineExtendsClause) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public InlineExtendsClause copy() {
        try {
            InlineExtendsClause node = (InlineExtendsClause) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public InlineExtendsClause fullCopy() {
     ...
     */
    public InlineExtendsClause treeCopyNoTransform() {
        InlineExtendsClause tree = (InlineExtendsClause) copy();
        if (children != null) {
     ...
     */
    public InlineExtendsClause treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /**
