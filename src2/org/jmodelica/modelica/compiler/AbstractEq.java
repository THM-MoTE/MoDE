 ...
 * @ast class
 * @aspect Graphs
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/structural/Graphs.jadd:1889
 */
public abstract class AbstractEq<E extends AbstractEq<E, V>, V extends AbstractVar<E, V>> extends Object {
    ...
    public AbstractEq(String name, FAbstractEquation eqn, int groupNumber, Collection<E> groupMembers, FTypePrefixVariability variability, FType type, boolean isMeta) {
        this.name = name;
        this.eqn = eqn;
