...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/InstanceTree.ast:117
...
public class InstArrayComponentDecl extends InstComponentDecl implements Cloneable {
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/ConstantEvaluation.jrag:3688
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/ErrorCheck.jrag:867
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/NameCheck.jadd:203
     */
    public void nameCheck(ErrorCheckType checkType) {}
    /**
     * @aspect InstaceConstrainingClauses
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1783
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:2695
     */
     ...
     */
    public InstArrayComponentDecl(InstAccess p0, Opt<FArraySubscripts> p1, ComponentDecl p2, Opt<InstModification> p3, Opt<InstConstrainingComponent> p4, Opt<FExp> p5, int p6) {
        setChild(p0, 0);
        setChild(p1, 1);
        setComponentDecl(p2);
        setChild(p3, 2);
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenComponentDecl_ComponentDecl == ((InstArrayComponentDecl)node).tokenComponentDecl_ComponentDecl) && (tokenint_Index == ((InstArrayComponentDecl)node).tokenint_Index);    
    }
    /**
    ...
    public FQName appendMyName(FQName prefix) {
        ASTNode$State state = state();
        FQName appendMyName_FQName_value = (getIndex() > 0) ? prefix.copyAndAddSubscript(new FIntegerSubscript(getIndex())) : prefix;
    ...
    public FTypePrefixVariability defaultVariability() {
        ASTNode$State state = state();
        FTypePrefixVariability defaultVariability_value = parentDefaultVariability();
    ...
    public Iterable<ComponentDecl> components() {
        ASTNode$State state = state();
        Iterable<ComponentDecl> components_value = instComponentDecl().components();
    ...
    public Iterable<ExtendsClause> superClasses() {
        ASTNode$State state = state();
        Iterable<ExtendsClause> superClasses_value = instComponentDecl().superClasses();
    ...
    public Iterable<ClassDecl> classes() {
        ASTNode$State state = state();
        Iterable<ClassDecl> classes_value = instComponentDecl().classes();
     ...
     * @attribute syn
     * @aspect InstArrays
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:2452
     */
    @ASTNodeAnnotation.Attribute
    ...
    public boolean subType(InstNode t, boolean top) {
        ASTNode$State state = state();
        boolean subType_InstNode_boolean_value = t.isArrayPartType() && compareCompositeTypes(t, this, top);
     ...
     * @attribute inh
     * @aspect Arrays
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/Arrays.jrag:362
     */
    @ASTNodeAnnotation.Attribute
    ...
    public FQName Define_expandedFQName(ASTNode caller, ASTNode child) {
        int childIndex = this.getIndexOfChild(caller);
        return appendMyName(expandedFQName());
    }
    /**
    ...
    public FExp Define_splitBindingFExp(ASTNode caller, ASTNode child, FExp fe, InstNode node) {
        int childIndex = this.getIndexOfChild(caller);
        return (node == this) ? fe : fe.dynamicFExp(splitBindingFExp(fe, node)).splitArrayExp(getIndex());
    }
    /**
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Flattening.jrag:1576
     * @apilevel internal
    ...
    public InstValueModification Define_parentInstValueMod(ASTNode caller, ASTNode child) {
        int childIndex = this.getIndexOfChild(caller);
        {
                ...
                return (ivm != null) ? ivm.arrayInstModification(getIndex()) : null;
            }
    }
    /**
    ...
    public InstLookupResult<InstClassDecl> Define_lookupInstClassInInstElement(ASTNode caller, ASTNode child, String name) {
        if (caller == getInstModificationOptNoTransform()) {
            ...
            return super.Define_lookupInstClassInInstElement(caller, child, name);
        }
    }
    /**
    ...
    public int Define_dimensionLength(ASTNode caller, ASTNode child, int i) {
        if (caller == getInstComponentDeclListNoTransform()) {
            ...
            return super.Define_dimensionLength(caller, child, i);
        }
    }
    /**
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:2463
