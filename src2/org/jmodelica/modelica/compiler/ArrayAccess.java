...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:396
 * @production ArrayAccess : {@link NamedAccess} ::= <span class="component">[{@link ArraySubscripts}]</span>;

 */
public class ArrayAccess extends NamedAccess implements Cloneable {
    /**
     * @aspect PrettyPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/PrettyPrint.jrag:828
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1494
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1119
     */
     ...
     */
    public ArrayAccess(String p0, Opt<ArraySubscripts> p1) {
        setID(p0);
        setChild(p1, 0);
    }
    /**
     ...
     */
    public ArrayAccess(Symbol p0, Opt<ArraySubscripts> p1) {
        setID(p0);
        setChild(p1, 0);
    }
    /**
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_ID == ((ArrayAccess)node).tokenString_ID);    
    }
    /**
    ...
    public boolean isArrayAccess() {
        ...
        boolean isArrayAccess_value = hasArraySubscripts();
    ...
    public ArraySubscripts arraySubscripts() {
        ASTNode$State state = state();
        ArraySubscripts arraySubscripts_value = hasArraySubscripts()? getArraySubscripts(): null;
