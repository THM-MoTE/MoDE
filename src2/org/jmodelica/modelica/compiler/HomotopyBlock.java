 ...
 * @ast class
 * @aspect BLT
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/structural/BLT.jrag:1987
 */
public class HomotopyBlock extends AbstractSubBLTBlock<BLT> {
    ...
    public void genBlockResidualFunction_C(CodePrinter p, CodeStream str, String outerIndent, boolean inInitial) {
        homotopySubBlock.genBlockResidualFunction_C(p, str, outerIndent, inInitial);
        CodePrinter simplifiedPrinter = p.homotopySimplifiedPrinter();
        for (AbstractEquationBlock block : subBLTs()[SIMPLIFIED_BLT_POS])
            block.genBlockResidualFunction_C(simplifiedPrinter, str, outerIndent, inInitial);
    }
    ...
    public void genBlock_C(CodePrinter p, CodeStream str, String indent, boolean inInitial) {
        ...
        CodePrinter simplifiedPrinter = p.homotopySimplifiedPrinter();
        for (AbstractEquationBlock block : subBLTs()[SIMPLIFIED_BLT_POS]) {
            block.genBlock_C(simplifiedPrinter, str, indent, inInitial); 
        }
        str.formatln("%s/* End of section for simplified version of homotopy*/", indent);
        homotopySubBlock.genBlock_C(p, str, indent, inInitial);
    }

    @Override
    public void genVarDecls_C(CodePrinter p, CodeStream str, String indent) {
        subBLTs()[SIMPLIFIED_BLT_POS].genVarDecls_C(p, str, indent);
    }
