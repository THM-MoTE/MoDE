...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:290
 * @production ElementModification : {@link NamedModification} ::= <span class="component">[{@link Modification}]</span> <span class="component">{@link Comment}</span>;

 */
public abstract class ElementModification extends NamedModification implements Cloneable {
    /**
     * @aspect PrettyPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/PrettyPrint.jrag:652
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1421
     */
     ...
     */
    public ElementModification(Opt<Each> p0, Opt<Final> p1, Access p2, Opt<Modification> p3, Comment p4) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public ElementModification clone() throws CloneNotSupportedException {
        ElementModification node = (ElementModification) super.clone();
        return node;
    }
    /**
     ...
     */
    public abstract ElementModification fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract ElementModification treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract ElementModification treeCopy();
    /**
