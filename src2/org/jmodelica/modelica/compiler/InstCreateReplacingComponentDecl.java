...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/InstanceTree.ast:135
 * @production InstCreateReplacingComponentDecl : {@link InstCreateComponentDecl} ::= <span class="component">&lt;OriginalDecl:ComponentDecl&gt;</span> <span class="component">&lt;InstComponentRedeclare:InstComponentRedeclare&gt;</span> <span class="component">&lt;InstConstrainingRedeclare:InstComponentRedeclare&gt;</span>;
...
public class InstCreateReplacingComponentDecl extends InstCreateComponentDecl implements Cloneable {
     ...
     * @aspect Constructors
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/Constructors.jrag:179
     */
    public InstCreateReplacingComponentDecl(
            ComponentDecl cd, InstLookupRedirectNode ln, ComponentDecl ocd, 
     ...
     */
    public InstCreateReplacingComponentDecl(InstAccess p0, Opt<FArraySubscripts> p1, ComponentDecl p2, Opt<InstModification> p3, Opt<InstConstrainingComponent> p4, Opt<FExp> p5, InstLookupRedirectNode p6, ComponentDecl p7, InstComponentRedeclare p8, InstComponentRedeclare p9) {
        setChild(p0, 0);
        setChild(p1, 1);
        setComponentDecl(p2);
        setChild(p3, 2);
        ...
        setInstConstrainingRedeclare(p9);
    }
    /**
     * @apilevel low-level
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenComponentDecl_ComponentDecl == ((InstCreateReplacingComponentDecl)node).tokenComponentDecl_ComponentDecl) && (tokenInstLookupRedirectNode_LookupNode == ((InstCreateReplacingComponentDecl)node).tokenInstLookupRedirectNode_LookupNode) && (tokenComponentDecl_OriginalDecl == ((InstCreateReplacingComponentDecl)node).tokenComponentDecl_OriginalDecl) && (tokenInstComponentRedeclare_InstComponentRedeclare == ((InstCreateReplacingComponentDecl)node).tokenInstComponentRedeclare_InstComponentRedeclare) && (tokenInstComponentRedeclare_InstConstrainingRedeclare == ((InstCreateReplacingComponentDecl)node).tokenInstComponentRedeclare_InstConstrainingRedeclare);    
    }
    /**
    ...
    public ASTNode rewriteTo() {
        // Declared at @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1074
    ...
    /**
     * @declaredat @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1074
     * @apilevel internal
     */    private InstComponentDecl rewriteRule0() {
        return getClassName().myInstClassDecl().newInstReplacingComponent(
                 getComponentDecl(), getOriginalDecl(), 
