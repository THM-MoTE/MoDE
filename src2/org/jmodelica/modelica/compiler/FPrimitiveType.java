 ...
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/ast/FlatModelica.ast:379
 * @production FPrimitiveType : {@link FType};

 */
public abstract class FPrimitiveType extends FType implements Cloneable {
    /**
    ...
    public String argTypeBase_C() {
        ASTNode$State state = state();
        String argTypeBase_C_value = "double";
