...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/InstanceTree.ast:47
...
public abstract class InstAbstractShortClassDecl extends InstBaseClassDecl implements Cloneable {
     ...
     */
    public InstAbstractShortClassDecl(ClassDecl p0, Opt<InstConstrainingClass> p1, InstRestriction p2) {
        setClassDecl(p0);
        setChild(p1, 0);
        setChild(p2, 1);
    }
    ...
    public ShortClassDecl getShortClassDecl() {
        ASTNode$State state = state();
        ShortClassDecl getShortClassDecl_value = (ShortClassDecl)getClassDecl();

        return getShortClassDecl_value;
    }
    /**
     * @apilevel internal
     */
