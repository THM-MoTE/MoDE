...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/InstanceTree.ast:128
 * @production InstReplacingPrimitive : {@link InstPrimitive} ::= <span class="component">&lt;OriginalDecl:ComponentDecl&gt;</span> <span class="component">OriginalInstComponent:{@link InstComponentDecl}</span> <span class="component">&lt;InstComponentRedeclare:InstComponentRedeclare&gt;</span>;

 */
public class InstReplacingPrimitive extends InstPrimitive implements Cloneable {
    /**
     * @aspect InstanceErrorCheck
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/ErrorCheck.jrag:1080
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/TypeCheck.jrag:77
     */
    ...
    /**
     * @aspect InstArrays
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:2515
     */
     ...
     */
    public InstReplacingPrimitive(InstAccess p0, Opt<FArraySubscripts> p1, ComponentDecl p2, Opt<InstModification> p3, Opt<InstConstrainingComponent> p4, Opt<FExp> p5, ComponentDecl p6, InstComponentRedeclare p7) {
        setChild(p0, 0);
        setChild(p1, 1);
        setComponentDecl(p2);
        setChild(p3, 2);
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenComponentDecl_ComponentDecl == ((InstReplacingPrimitive)node).tokenComponentDecl_ComponentDecl) && (tokenComponentDecl_OriginalDecl == ((InstReplacingPrimitive)node).tokenComponentDecl_OriginalDecl) && (tokenInstComponentRedeclare_InstComponentRedeclare == ((InstReplacingPrimitive)node).tokenInstComponentRedeclare_InstComponentRedeclare);    
    }
    /**
