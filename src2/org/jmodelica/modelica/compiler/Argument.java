...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:287
 * @production Argument : {@link Modification} ::= <span class="component">[{@link Each}]</span> <span class="component">[{@link Final}]</span>;

 */
public abstract class Argument extends Modification implements Cloneable {
    /**
     ...
     */
    public Argument(Opt<Each> p0, Opt<Final> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /**
     ...
     */
    public abstract Argument fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract Argument treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract Argument treeCopy();
    /**
