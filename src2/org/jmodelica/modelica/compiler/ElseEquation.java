...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:314
 * @production ElseEquation : {@link IfWhenElseEquation};

 */
public class ElseEquation extends IfWhenElseEquation implements Cloneable {
    /**
     * @aspect InstantiatedExpressions
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Flattening.jrag:2871
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:808
     */
    @Override
    ...
    /**
     * @aspect FormattedPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1664
     */
    void prettyPrintFormattedHelper(Printer printer, CodeStream printStream, boolean elseIf) {
     ...
     */
    public ElseEquation(Opt<AbstractEquationModifier> p0, Comment p1, List<AbstractEquation> p2) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
    }
     ...
     */
    public ElseEquation clone() throws CloneNotSupportedException {
        ElseEquation node = (ElseEquation) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public ElseEquation copy() {
        try {
            ElseEquation node = (ElseEquation) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public ElseEquation treeCopyNoTransform() {
        ElseEquation tree = (ElseEquation) copy();
        if (children != null) {
