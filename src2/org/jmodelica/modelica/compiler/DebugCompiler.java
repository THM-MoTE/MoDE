 ...
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaCompiler/src/jastadd/DebugCompiler.jrag:29
 */
	...
	public class CompilationThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                mc.compileModel(new String[] { file.getAbsolutePath() }, name, targ, null);
            } catch (Exception ex) {
