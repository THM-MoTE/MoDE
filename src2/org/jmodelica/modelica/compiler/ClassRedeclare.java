...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:294
 * @production ClassRedeclare : {@link ElementRedeclare} ::= <span class="component">{@link BaseClassDecl}</span>;

 */
public class ClassRedeclare extends ElementRedeclare implements Cloneable {
    /**
     * @aspect PrettyPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/PrettyPrint.jrag:673
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:258
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1435
     */
     ...
     */
    public ClassRedeclare(Opt<Each> p0, Opt<Final> p1, Access p2, BaseClassDecl p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public ClassRedeclare clone() throws CloneNotSupportedException {
        ClassRedeclare node = (ClassRedeclare) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public ClassRedeclare copy() {
        try {
            ClassRedeclare node = (ClassRedeclare) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public ClassRedeclare fullCopy() {
     ...
     */
    public ClassRedeclare treeCopyNoTransform() {
        ClassRedeclare tree = (ClassRedeclare) copy();
        if (children != null) {
     ...
     */
    public ClassRedeclare treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /**
    ...
    /**
     * Replaces the BaseClassDecl child.
     * @param node The new node to replace the BaseClassDecl child.
     * @apilevel high-level
     */
    public void setBaseClassDecl(BaseClassDecl node) {
        setChild(node, 3);
    }
    /**
     * Retrieves the BaseClassDecl child.
     * @return The current node used as the BaseClassDecl child.
     * @apilevel high-level
     */
    @ASTNodeAnnotation.Child(name="BaseClassDecl")
    public BaseClassDecl getBaseClassDecl() {
        return (BaseClassDecl) getChild(3);
    }
    /**
     * Retrieves the BaseClassDecl child.
     * <p><em>This method does not invoke AST transformations.</em></p>
     ...
     * @apilevel low-level
     */
    public BaseClassDecl getBaseClassDeclNoTransform() {
        return (BaseClassDecl) getChildNoTransform(3);
    }
    /**
    ...
    public VisibilityType Define_visibility(ASTNode caller, ASTNode child) {
        if (caller == getBaseClassDeclNoTransform()) {
    ...
    public boolean Define_shouldOnlyFormatChildren(ASTNode caller, ASTNode child) {
        if (caller == getBaseClassDeclNoTransform()) {
            ...
            return super.Define_shouldOnlyFormatChildren(caller, child);
        }
    }
    /**
     * @apilevel internal
