...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/InstanceTree.ast:60
 * @production InstReplacingShortClassDecl : {@link InstShortClassDecl} ::= <span class="component">&lt;OriginalClassDecl:ClassDecl&gt;</span> <span class="component">OriginalInstClass:{@link InstClassDecl}</span> <span class="component">&lt;InstClassRedeclare:InstRedeclareClassNode&gt;</span>;

 */
public class InstReplacingShortClassDecl extends InstShortClassDecl implements Cloneable {
    /**
     * @aspect InstanceErrorCheck
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/ErrorCheck.jrag:1031
     */
    public void collectInstModificationErrors(ErrorCheckType checkType) { }
    /**
     * @aspect InstanceErrorCheck
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/ErrorCheck.jrag:1033
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1124
     */
    ...
    /**
     * @aspect InstanceTreeConstruction
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1606
     */
    public InstReplacingSimpleShortClassDecl createInstSimpleShortClassDecl() {
		return new InstReplacingSimpleShortClassDecl(getClassDecl(), getInstConstrainingClassOpt(), 
     ...
     */
    public InstReplacingShortClassDecl(ClassDecl p0, Opt<InstConstrainingClass> p1, InstRestriction p2, Opt<FArraySubscripts> p3, ClassDecl p4, InstRedeclareClassNode p5) {
        setClassDecl(p0);
        setChild(p1, 0);
        setChild(p2, 1);
        setChild(p3, 2);
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenClassDecl_ClassDecl == ((InstReplacingShortClassDecl)node).tokenClassDecl_ClassDecl) && (tokenClassDecl_OriginalClassDecl == ((InstReplacingShortClassDecl)node).tokenClassDecl_OriginalClassDecl) && (tokenInstRedeclareClassNode_InstClassRedeclare == ((InstReplacingShortClassDecl)node).tokenInstRedeclareClassNode_InstClassRedeclare);    
    }
    /**
    ...
    public FQName Define_retrieveFQName(ASTNode caller, ASTNode child) {
        if (caller == getOriginalInstClassNoTransform()) {
            ...
            return (isFunction() || isRecord()) ? new FQNameEmpty() : retrieveFQName();
        }
    }
    /**
    ...
    public Environment Define_myEnvironment(ASTNode caller, ASTNode child) {
        if (caller == getOriginalInstClassNoTransform()) {
            ...
            return super.Define_myEnvironment(caller, child);
        }
    }
    /**
    ...
    public Environment Define_myEnvironment(ASTNode caller, ASTNode child, String name) {
        if (caller == getOriginalInstClassNoTransform()) {
            ...
            return super.Define_myEnvironment(caller, child, name);
        }
    }
    /**
     * @apilevel internal
