...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/InstanceTree.ast:184
 * @production InstRecordModification : {@link InstValueModification} ::= <span class="component">&lt;Name:String&gt;</span>;

 */
public abstract class InstRecordModification extends InstValueModification implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public InstRecordModification() {
        super();
    }
    /**
     ...
     */
    public InstRecordModification(Modification p0, String p1) {
        setModification(p0);
        setName(p1);
    }
    /**
     ...
     */
    public InstRecordModification(Modification p0, Symbol p1) {
        setModification(p0);
        setName(p1);
    }
    /**
     ...
     */
    public InstRecordModification clone() throws CloneNotSupportedException {
        InstRecordModification node = (InstRecordModification) super.clone();
        return node;
    }
    /**
     ...
     */
    public abstract InstRecordModification fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract InstRecordModification treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract InstRecordModification treeCopy();
    /**
