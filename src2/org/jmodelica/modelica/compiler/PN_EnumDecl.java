...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:150
 * @production PN_EnumDecl : {@link BaseClassDecl} ::= <span class="component">&lt;Symbol:Symbol&gt;</span> <span class="component">{@link EnumSpecification}</span> <span class="component">{@link Comment}</span>;

 */
public class PN_EnumDecl extends BaseClassDecl implements Cloneable {
    /**
     ...
     */
    public PN_EnumDecl(IdDecl p0, VisibilityType p1, Opt<Encapsulated> p2, Opt<Partial> p3, Restriction p4, Opt<Redeclare> p5, Opt<Final> p6, Opt<Inner> p7, Opt<Outer> p8, Opt<Replaceable> p9, Opt<ConstrainingClause> p10, Opt<Comment> p11, Symbol p12, EnumSpecification p13, Comment p14) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public PN_EnumDecl clone() throws CloneNotSupportedException {
        PN_EnumDecl node = (PN_EnumDecl) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public PN_EnumDecl copy() {
        try {
            PN_EnumDecl node = (PN_EnumDecl) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public PN_EnumDecl treeCopyNoTransform() {
        PN_EnumDecl tree = (PN_EnumDecl) copy();
        if (children != null) {
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenSymbol_Symbol == ((PN_EnumDecl)node).tokenSymbol_Symbol);    
    }
    /**
    ...
    /**
     * Replaces the lexeme Symbol.
     * @param value The new value for the lexeme Symbol.
     * @apilevel high-level
     */
    public void setSymbol(Symbol value) {
        tokenSymbol_Symbol = value;
    }
    /**
     * @apilevel internal
     */
    protected Symbol tokenSymbol_Symbol;
    /**
     * Retrieves the value for the lexeme Symbol.
     * @return The value for the lexeme Symbol.
     * @apilevel high-level
     */
    @ASTNodeAnnotation.Token(name="Symbol")
    public Symbol getSymbol() {
        return tokenSymbol_Symbol;
    }
    /**
     * Replaces the EnumSpecification child.
     * @param node The new node to replace the EnumSpecification child.
     * @apilevel high-level
     */
    public void setEnumSpecification(EnumSpecification node) {
        setChild(node, 12);
    }
    /**
     * Retrieves the EnumSpecification child.
     * @return The current node used as the EnumSpecification child.
     * @apilevel high-level
     */
    @ASTNodeAnnotation.Child(name="EnumSpecification")
    public EnumSpecification getEnumSpecification() {
        return (EnumSpecification) getChild(12);
    }
    /**
     * Retrieves the EnumSpecification child.
     * <p><em>This method does not invoke AST transformations.</em></p>
     ...
     * @apilevel low-level
     */
    public EnumSpecification getEnumSpecificationNoTransform() {
        return (EnumSpecification) getChildNoTransform(12);
    }
    /**
    ...
    public ASTNode rewriteTo() {
        // Declared at @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/InitialTransformations.jrag:157
    ...
    /**
     * @declaredat @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/InitialTransformations.jrag:157
     * @apilevel internal
     */
    private EnumClassDecl rewriteRule0() {
{
