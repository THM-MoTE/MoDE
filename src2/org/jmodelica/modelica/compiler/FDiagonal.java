 ...
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/ast/FlatModelica.ast:1641
...
public class FDiagonal extends FAbstractDiagonal implements Cloneable {
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/Constructors.jrag:1156
     */
    public FDiagonal createEmptyNode()        { return new FDiagonal();        }
    /**
     * @aspect Derivatives
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaMiddleEnd/src/jastadd/structural/Differentiation.jrag:682
     */
    ...
    @ASTNodeAnnotation.Attribute
    public FExp scalarizeDiagonalElement(Map<String,FExp> indexMap) {
        ASTNode$State state = state();
        FExp scalarizeDiagonalElement_Map_String_FExp__value = getFExp().scalarize(indexMap);

        return scalarizeDiagonalElement_Map_String_FExp__value;
    }
    /**
     * @apilevel internal
     */
