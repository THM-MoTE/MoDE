...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:98
 * @production PN_FullClassDecl : {@link BaseClassDecl} ::= <span class="component">[{@link StringComment}]</span> <span class="component">{@link Composition}</span> <span class="component">[{@link Annotation}]</span> <span class="component">{@link EndDecl}</span>;

 */
public class PN_FullClassDecl extends BaseClassDecl implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public PN_FullClassDecl() {
        super();
    }
    /**
     ...
     */
    public PN_FullClassDecl(IdDecl p0, VisibilityType p1, Opt<Encapsulated> p2, Opt<Partial> p3, Restriction p4, Opt<Redeclare> p5, Opt<Final> p6, Opt<Inner> p7, Opt<Outer> p8, Opt<Replaceable> p9, Opt<ConstrainingClause> p10, Opt<Comment> p11, Opt<StringComment> p12, Composition p13, Opt<Annotation> p14, EndDecl p15) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public PN_FullClassDecl clone() throws CloneNotSupportedException {
        PN_FullClassDecl node = (PN_FullClassDecl) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public PN_FullClassDecl copy() {
        try {
            PN_FullClassDecl node = (PN_FullClassDecl) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public PN_FullClassDecl fullCopy() {
     ...
     */
    public PN_FullClassDecl treeCopyNoTransform() {
        PN_FullClassDecl tree = (PN_FullClassDecl) copy();
        if (children != null) {
     ...
     */
    public PN_FullClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /**
    ...
    public ASTNode rewriteTo() {
        // Declared at @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/InitialTransformations.jrag:55
    ...
    /**
     * @declaredat @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/InitialTransformations.jrag:55
     * @apilevel internal
     */
    private FullClassDecl rewriteRule0() {
{ 
