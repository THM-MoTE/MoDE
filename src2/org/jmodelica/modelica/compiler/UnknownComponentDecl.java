...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:218
 * @production UnknownComponentDecl : {@link ComponentDecl};

 */
public class UnknownComponentDecl extends ComponentDecl implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public UnknownComponentDecl() {
        super();
    }
    /**
     ...
     */
    public UnknownComponentDecl clone() throws CloneNotSupportedException {
        UnknownComponentDecl node = (UnknownComponentDecl) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public UnknownComponentDecl copy() {
        try {
            UnknownComponentDecl node = (UnknownComponentDecl) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public UnknownComponentDecl fullCopy() {
     ...
     */
    public UnknownComponentDecl treeCopyNoTransform() {
        UnknownComponentDecl tree = (UnknownComponentDecl) copy();
        if (children != null) {
     ...
     */
    public UnknownComponentDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /**
    ...
    public UnknownComponentDecl unknownComponentDecl() {
        ...
        UnknownComponentDecl unknownComponentDecl_value = this;
