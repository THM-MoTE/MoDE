...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:96
 * @production UnknownClassDecl : {@link FullClassDecl};

 */
public class UnknownClassDecl extends FullClassDecl implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public UnknownClassDecl() {
        super();
    }
    /**
     ...
     */
    public UnknownClassDecl clone() throws CloneNotSupportedException {
        UnknownClassDecl node = (UnknownClassDecl) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public UnknownClassDecl copy() {
        try {
            UnknownClassDecl node = (UnknownClassDecl) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public UnknownClassDecl fullCopy() {
     ...
     */
    public UnknownClassDecl treeCopyNoTransform() {
        UnknownClassDecl tree = (UnknownClassDecl) copy();
        if (children != null) {
     ...
     */
    public UnknownClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /**
    ...
    public UnknownClassDecl unknownClassDecl() {
        ASTNode$State state = state();
        UnknownClassDecl unknownClassDecl_value = this;
