...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:372
 * @production RangeExp : {@link Exp} ::= <span class="component">{@link Exp}*</span>;

 */
public class RangeExp extends Exp implements Cloneable {
    /**
     * @aspect PrettyPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/PrettyPrint.jrag:612
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Flattening.jrag:3069
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1751
     */
     ...
     */
    public RangeExp clone() throws CloneNotSupportedException {
        RangeExp node = (RangeExp) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public RangeExp copy() {
        try {
            RangeExp node = (RangeExp) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public RangeExp treeCopyNoTransform() {
        RangeExp tree = (RangeExp) copy();
        if (children != null) {
