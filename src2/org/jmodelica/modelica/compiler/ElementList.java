...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:200
 * @production ElementList : {@link Clause} ::= <span class="component">{@link Element}*</span>;

 */
public abstract class ElementList extends Clause implements Cloneable {
    /**
     ...
     */
    public ElementList(List<Element> p0) {
        setChild(p0, 0);
    }
    /**
     * @apilevel low-level
     ...
     */
    public ElementList clone() throws CloneNotSupportedException {
        ElementList node = (ElementList) super.clone();
        return node;
    }
    /**
     ...
     */
    public abstract ElementList fullCopy();
    /**
     * Create a deep copy of the AST subtree at this node.
     * The copy is dangling, i.e. has no parent.
     * @return dangling copy of the subtree at this node
     ...
     */
    public abstract ElementList treeCopyNoTransform();
    /**
     * Create a deep copy of the AST subtree at this node.
     ...
     */
    public abstract ElementList treeCopy();
    /**
