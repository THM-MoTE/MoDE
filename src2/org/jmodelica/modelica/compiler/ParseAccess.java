...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:397
 * @production ParseAccess : {@link ArrayAccess};

 */
public class ParseAccess extends ArrayAccess implements Cloneable {
    /**
     * Constructs a parse access from a String.
     * @aspect Constructors
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/Constructors.jrag:59
     */
    public ParseAccess(String name) {
		this();
		setID(name);
	}
    /**
     ...
     */
    public ParseAccess(String p0, Opt<ArraySubscripts> p1) {
        setID(p0);
        setChild(p1, 0);
    }
    /**
     ...
     */
    public ParseAccess(Symbol p0, Opt<ArraySubscripts> p1) {
        setID(p0);
        setChild(p1, 0);
    }
    /**
     ...
     */
    public ParseAccess clone() throws CloneNotSupportedException {
        ParseAccess node = (ParseAccess) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public ParseAccess copy() {
        try {
            ParseAccess node = (ParseAccess) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public ParseAccess treeCopyNoTransform() {
        ParseAccess tree = (ParseAccess) copy();
        if (children != null) {
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenString_ID == ((ParseAccess)node).tokenString_ID);    
    }
    /**
