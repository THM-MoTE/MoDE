...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Error.ast:18
 * @production BadClassDecl : {@link BaseClassDecl};

 */
public class BadClassDecl extends BaseClassDecl implements Cloneable {
    /**
     * @aspect ErrorClasses
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/ErrorClasses.jrag:45
     */
    ...
    /**
     * @aspect ErrorClasses
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/ErrorClasses.jrag:87
     */
    private BadNodeInfo badNodeInfo = null;
    /**
     * @aspect ErrorClasses
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/ErrorClasses.jrag:98
     */
    ...
    /**
     * @aspect ErrorClasses
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/errorcheck/ErrorClasses.jrag:131
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1358
     */
    public BadInstClassDecl newInstClassDecl() {
        BadInstClassDecl ecd = new BadInstClassDecl(this, new Opt<InstConstrainingClass>(), new InstMClass(), new Opt<InstExternal>());
        return ecd;
    }
    /**
     ...
     */
    public BadClassDecl(IdDecl p0, VisibilityType p1, Opt<Encapsulated> p2, Opt<Partial> p3, Restriction p4, Opt<Redeclare> p5, Opt<Final> p6, Opt<Inner> p7, Opt<Outer> p8, Opt<Replaceable> p9, Opt<ConstrainingClause> p10, Opt<Comment> p11) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public BadClassDecl clone() throws CloneNotSupportedException {
        BadClassDecl node = (BadClassDecl) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public BadClassDecl copy() {
        try {
            BadClassDecl node = (BadClassDecl) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public BadClassDecl treeCopyNoTransform() {
        BadClassDecl tree = (BadClassDecl) copy();
        if (children != null) {
