...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/InstanceTree.ast:64
 * @production InstReplacingSimpleShortClassDecl : {@link InstSimpleShortClassDecl} ::= <span class="component">&lt;OriginalClassDecl:ClassDecl&gt;</span> <span class="component">OriginalInstClass:{@link InstClassDecl}</span> <span class="component">&lt;InstClassRedeclare:InstRedeclareClassNode&gt;</span>;

 */
public class InstReplacingSimpleShortClassDecl extends InstSimpleShortClassDecl implements Cloneable {
    /**
     * @aspect InstanceTreeConstruction
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/instance/InstanceTree.jrag:1128
     */
     ...
     */
    public InstReplacingSimpleShortClassDecl(ClassDecl p0, Opt<InstConstrainingClass> p1, InstRestriction p2, ClassDecl p3, InstRedeclareClassNode p4) {
        setClassDecl(p0);
        setChild(p1, 0);
        setChild(p2, 1);
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenClassDecl_ClassDecl == ((InstReplacingSimpleShortClassDecl)node).tokenClassDecl_ClassDecl) && (tokenClassDecl_OriginalClassDecl == ((InstReplacingSimpleShortClassDecl)node).tokenClassDecl_OriginalClassDecl) && (tokenInstRedeclareClassNode_InstClassRedeclare == ((InstReplacingSimpleShortClassDecl)node).tokenInstRedeclareClassNode_InstClassRedeclare);    
    }
    /**
