...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:312
 * @production IfEquation : {@link IfWhenEquation};

 */
public class IfEquation extends IfWhenEquation implements Cloneable {
    /**
     * @aspect InstantiatedExpressions
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Flattening.jrag:2863
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:377
     */
    @Override
     ...
     */
    public IfEquation(Opt<AbstractEquationModifier> p0, Comment p1, List<AbstractEquation> p2, Exp p3, Opt<IfWhenElseEquation> p4) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public IfEquation clone() throws CloneNotSupportedException {
        IfEquation node = (IfEquation) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public IfEquation copy() {
        try {
            IfEquation node = (IfEquation) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public IfEquation treeCopyNoTransform() {
        IfEquation tree = (IfEquation) copy();
        if (children != null) {
