...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:115
 * @production LibClassDecl : {@link FullClassDecl} ::= <span class="component">{@link LibNode}*</span>;

 */
public class LibClassDecl extends FullClassDecl implements Cloneable {
    /**
     * @aspect Library
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/Library.jrag:155
     */
    private java.util.List<String> order = Collections.emptyList();
    /**
     * @aspect Library
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/Library.jrag:157
     */
    ...
    /**
     * @aspect Library
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/Library.jrag:177
     */
    public LibClassDecl(FullClassDecl fcd) {
        assignFields(fcd);
        originalComposition = fcd.originalComposition;
    }
    /**
     * @aspect Library
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/Library.jrag:182
     */
    public void assignFields(FullClassDecl fcd) {
    ...
    /**
     * @aspect DumpClasses
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/DumpTree.jadd:437
     */
...
//			    System.out.println("### #" + ln.getStoredDefinition().getFileName());
    ...
    public void init$Children() {
        ...
        setChild(new Opt(), 20);
        setChild(new Opt(), 21);
        setChild(new List(), 23);
    }
    /**
     * @declaredat ASTNode:33
     */
    public LibClassDecl(IdDecl p0, VisibilityType p1, Opt<Encapsulated> p2, Opt<Partial> p3, Restriction p4, Opt<Redeclare> p5, Opt<Final> p6, Opt<Inner> p7, Opt<Outer> p8, Opt<Replaceable> p9, Opt<ConstrainingClause> p10, Opt<Comment> p11, Opt<StringComment> p12, List<AbstractEquation> p13, List<Algorithm> p14, List<ExtendsClause> p15, List<ImportClause> p16, List<ClassDecl> p17, List<ComponentDecl> p18, List<Modification> p19, Opt<ExternalClause> p20, Opt<Annotation> p21, EndDecl p22, List<LibNode> p23) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public LibClassDecl clone() throws CloneNotSupportedException {
        LibClassDecl node = (LibClassDecl) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public LibClassDecl copy() {
        try {
            LibClassDecl node = (LibClassDecl) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public LibClassDecl treeCopyNoTransform() {
        LibClassDecl tree = (LibClassDecl) copy();
        if (children != null) {
    ...
    /**
     * Replaces the LibNode list.
     * @param list The new list node to be used as the LibNode list.
     * @apilevel high-level
     */
    public void setLibNodeList(List<LibNode> list) {
        setChild(list, 23);
    }
    /**
     ...
     * @apilevel high-level
     */
    @ASTNodeAnnotation.ListChild(name="LibNode")
    public List<LibNode> getLibNodeList() {
        List<LibNode> list = (List<LibNode>) getChild(23);
        list.getNumChild();
        return list;
    }
    /**
    ...
    public List<LibNode> getLibNodeListNoTransform() {
        return (List<LibNode>) getChildNoTransform(23);
    }
    /**
     * Retrieves the LibNode list.
     * @return The node representing the LibNode list.
     ...
     * @apilevel internal
     */
    protected Iterable<ClassDecl> classes_value;
    /**
     * @apilevel internal
     */
     ...
     * @apilevel internal
     */
    private Iterable<ClassDecl> classes_compute() {
    ...
    public BaseClassDecl Define_enclosingClassDecl(ASTNode caller, ASTNode child) {
        if (caller == getLibNodeListNoTransform()) {
            int childIndex = caller.getIndexOfChild(child);
            return this;
        }
        else {
            return super.Define_enclosingClassDecl(caller, child);
        }
    }
    /**
