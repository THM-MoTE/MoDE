...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:382
 * @production OrExp : {@link LogBinExp};

 */
public class OrExp extends LogBinExp implements Cloneable {
    /**
     * @aspect InstantiatedExpressions
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Flattening.jrag:3169
     */
     ...
     */
    public OrExp treeCopyNoTransform() {
        OrExp tree = (OrExp) copy();
        if (children != null) {
    ...
    public String operatorFormatted() {
        ASTNode$State state = state();
        String operatorFormatted_value = "or";
