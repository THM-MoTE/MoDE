...
/**
 * @ast class
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/TestFramework/src/jastadd/TokenTester.jrag:31
 */
public class TokenTester extends Object {
    public  boolean test(String s1, String s2) {
		boolean testSuccess = true;
		boolean done = false;

		AbstractFlatModelicaScanner fms1 = 
			ParserHandler.createModelicaFlatScanner(new StringReader(s1));
		AbstractFlatModelicaScanner fms2 = 
			ParserHandler.createModelicaFlatScanner(new StringReader(s2));
