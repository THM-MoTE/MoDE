...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/InstanceTree.ast:94
 * @production InstConstrainingComponent : {@link InstConstraining} ::= <span class="component">&lt;ComponentDecl:ComponentDecl&gt;</span> <span class="component">&lt;InstRedeclare:InstComponentRedeclare&gt;</span>;
...
public class InstConstrainingComponent extends InstConstraining implements Cloneable {
     ...
     */
    public InstConstrainingComponent(InstAccess p0, Opt<InstClassModification> p1, ComponentDecl p2, InstComponentRedeclare p3) {
        setChild(p0, 0);
        setChild(p1, 1);
        setComponentDecl(p2);
        setInstRedeclare(p3);
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenComponentDecl_ComponentDecl == ((InstConstrainingComponent)node).tokenComponentDecl_ComponentDecl) && (tokenInstComponentRedeclare_InstRedeclare == ((InstConstrainingComponent)node).tokenInstComponentRedeclare_InstRedeclare);    
    }
    /**
    ...
    public ConstrainingClause getConstrainingClause() {
        ...
        getConstrainingClause_value = getComponentDecl().getConstrainingClause();
    ...
    public InstBaseNode getInstNode() {
        ...
        int num = state.boundariesCrossed;
        boolean isFinal = this.is$Final();
        getInstNode_value = getClassName().myInstClassDecl().newInstConstrainingComponentDecl(getComponentDecl(), getConstrainingClause().getAccess());
