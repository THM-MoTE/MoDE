...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/InstanceTree.ast:89
...
public class InstImportUnqualified extends InstImport implements Cloneable {
     ...
     */
    public InstImportUnqualified(InstAccess p0, ImportClause p1) {
        setChild(p0, 0);
        setImportClause(p1);
    }
    /**
    ...
    protected boolean is$Equal(ASTNode node) {
        return super.is$Equal(node) && (tokenImportClause_ImportClause == ((InstImportUnqualified)node).tokenImportClause_ImportClause);    
    }
    /**
