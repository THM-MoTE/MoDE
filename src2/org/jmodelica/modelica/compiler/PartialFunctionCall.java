...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:366
 * @production PartialFunctionCall : {@link FunctionCall};

 */
public class PartialFunctionCall extends FunctionCall implements Cloneable {
    /**
     * @aspect InstantiatedExpressions
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/flattening/Flattening.jrag:3220
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1682
     */
     ...
     */
    public PartialFunctionCall(Access p0, Opt<FunctionArguments> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /**
     ...
     */
    public PartialFunctionCall clone() throws CloneNotSupportedException {
        PartialFunctionCall node = (PartialFunctionCall) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public PartialFunctionCall copy() {
        try {
            PartialFunctionCall node = (PartialFunctionCall) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public PartialFunctionCall fullCopy() {
     ...
     */
    public PartialFunctionCall treeCopyNoTransform() {
        PartialFunctionCall tree = (PartialFunctionCall) copy();
        if (children != null) {
     ...
     */
    public PartialFunctionCall treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /**
