...
/**
 * @ast class
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/TestFramework/src/jastadd/TestSuite.jrag:27
 */
public class TestSuite extends Object implements GenericTestSuite {
    ...
    public  TestSuite(String fileName, String className, Assert asserter) {
        ...
        options.setStringOption("MODELICAPATH", modelica_path);
        ASTNode.log = new SysErrLogger();
        try {
            sr = ParserHandler.parseFile(UtilInterface.create(options), fileName);
        } catch (Exception e) {
