...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:139
 * @production PN_ExtendClassDecl : {@link PN_FullClassDecl} ::= <span class="component">[{@link ClassModification}]</span>;

 */
public class PN_ExtendClassDecl extends PN_FullClassDecl implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public PN_ExtendClassDecl() {
        super();
    }
    /**
     ...
     */
    public PN_ExtendClassDecl(IdDecl p0, VisibilityType p1, Opt<Encapsulated> p2, Opt<Partial> p3, Restriction p4, Opt<Redeclare> p5, Opt<Final> p6, Opt<Inner> p7, Opt<Outer> p8, Opt<Replaceable> p9, Opt<ConstrainingClause> p10, Opt<Comment> p11, Opt<StringComment> p12, Composition p13, Opt<Annotation> p14, EndDecl p15, Opt<ClassModification> p16) {
        setChild(p0, 0);
        setChild(p1, 1);
        setChild(p2, 2);
        setChild(p3, 3);
     ...
     */
    public PN_ExtendClassDecl clone() throws CloneNotSupportedException {
        PN_ExtendClassDecl node = (PN_ExtendClassDecl) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public PN_ExtendClassDecl copy() {
        try {
            PN_ExtendClassDecl node = (PN_ExtendClassDecl) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public PN_ExtendClassDecl fullCopy() {
     ...
     */
    public PN_ExtendClassDecl treeCopyNoTransform() {
        PN_ExtendClassDecl tree = (PN_ExtendClassDecl) copy();
        if (children != null) {
     ...
     */
    public PN_ExtendClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /**
    ...
    /**
     * Replaces the Composition child.
     * @param node The new node to replace the Composition child.
     * @apilevel high-level
     */
    public void setComposition(Composition node) {
        setChild(node, 13);
    }
    /**
     * Retrieves the Composition child.
     * @return The current node used as the Composition child.
     * @apilevel high-level
     */
    @ASTNodeAnnotation.Child(name="Composition")
    public Composition getComposition() {
        return (Composition) getChild(13);
    }
    /**
     * Retrieves the Composition child.
     * <p><em>This method does not invoke AST transformations.</em></p>
     ...
     * @apilevel low-level
     */
    public Composition getCompositionNoTransform() {
        return (Composition) getChildNoTransform(13);
    }
    /**
    ...
    public Opt<Annotation> getAnnotationOpt() {
        return (Opt<Annotation>) getChild(14);
    }
    /**
    ...
    public Opt<Annotation> getAnnotationOptNoTransform() {
        return (Opt<Annotation>) getChildNoTransform(14);
    }
    /**
    ...
    public EndDecl getEndDeclNoTransform() {
        return (EndDecl) getChildNoTransform(15);
    }
    /**
    ...
    public Opt<ClassModification> getClassModificationOpt() {
        return (Opt<ClassModification>) getChild(16);
    }
    /**
    ...
    public Opt<ClassModification> getClassModificationOptNoTransform() {
        return (Opt<ClassModification>) getChildNoTransform(16);
    }
    /**
     * @apilevel internal
     */
    public ASTNode rewriteTo() {
        // Declared at @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/InitialTransformations.jrag:109
    ...
    /**
     * @declaredat @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/source/InitialTransformations.jrag:109
     * @apilevel internal
     */
    private ExtendClassDecl rewriteRule0() {
{ 
