...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:144
 * @production RealClassDecl : {@link PrimitiveClassDecl};

 */
public class RealClassDecl extends PrimitiveClassDecl implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public RealClassDecl() {
        super();
    }
    /**
     ...
     */
    public RealClassDecl clone() throws CloneNotSupportedException {
        RealClassDecl node = (RealClassDecl) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public RealClassDecl copy() {
        try {
            RealClassDecl node = (RealClassDecl) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public RealClassDecl treeCopyNoTransform() {
        RealClassDecl tree = (RealClassDecl) copy();
        if (children != null) {
