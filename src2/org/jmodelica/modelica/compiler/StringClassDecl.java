...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:147
 * @production StringClassDecl : {@link PrimitiveClassDecl};

 */
public class StringClassDecl extends PrimitiveClassDecl implements Cloneable {
    /**
     * @declaredat ASTNode:1
     */
    public StringClassDecl() {
        super();
    }
    /**
     ...
     */
    public StringClassDecl clone() throws CloneNotSupportedException {
        StringClassDecl node = (StringClassDecl) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public StringClassDecl copy() {
        try {
            StringClassDecl node = (StringClassDecl) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public StringClassDecl fullCopy() {
     ...
     */
    public StringClassDecl treeCopyNoTransform() {
        StringClassDecl tree = (StringClassDecl) copy();
        if (children != null) {
     ...
     */
    public StringClassDecl treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /**
