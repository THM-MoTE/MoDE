 ...
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/ast/FlatModelica.ast:20
...
public class FlatRoot extends Root implements Cloneable {
    ...
    public void flushCollectionCache() {
        ...
        collect_contributors_FClass_guardExpInEquations = false;
        collect_contributors_FClass_guardExpInInitialEquations = false;
        collect_contributors_FAbstractVariable_dependentParameters = false;
    }
    /**
     * @api internal
     ...
     */
        private boolean collect_contributors_FClass_guardExpInEquations = false;
    protected void collect_contributors_FClass_guardExpInEquations() {
        if(collect_contributors_FClass_guardExpInEquations) return;
        super.collect_contributors_FClass_guardExpInEquations();
        collect_contributors_FClass_guardExpInEquations = true;
    }
     ...
     */
        private boolean collect_contributors_FClass_guardExpInInitialEquations = false;
    protected void collect_contributors_FClass_guardExpInInitialEquations() {
        if(collect_contributors_FClass_guardExpInInitialEquations) return;
        super.collect_contributors_FClass_guardExpInInitialEquations();
        collect_contributors_FClass_guardExpInInitialEquations = true;
    }
     ...
     */
        private boolean collect_contributors_FAbstractVariable_dependentParameters = false;
    protected void collect_contributors_FAbstractVariable_dependentParameters() {
        if(collect_contributors_FAbstractVariable_dependentParameters) return;
        super.collect_contributors_FAbstractVariable_dependentParameters();
        collect_contributors_FAbstractVariable_dependentParameters = true;
    }
