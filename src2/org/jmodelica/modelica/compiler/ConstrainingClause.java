...
/**
 * @ast node
 * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/ast/Modelica.ast:160
 * @production ConstrainingClause : {@link SourceBaseNode} ::= <span class="component">{@link Access}</span> <span class="component">[{@link ClassModification}]</span>;

 */
public class ConstrainingClause extends SourceBaseNode implements Cloneable {
    /**
     * @aspect PrettyPrint
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFlatTree/src/jastadd/PrettyPrint.jrag:584
     */
     ...
     * @declaredat /home/hobbypunk/Dokumente/Entwicklung/THM_Projekte/Projektphase/jModelica/Compiler/ModelicaFrontEnd/src/jastadd/util/FormattedPrint.jrag:1189
     */
     ...
     */
    public ConstrainingClause(Access p0, Opt<ClassModification> p1) {
        setChild(p0, 0);
        setChild(p1, 1);
    }
    /**
     ...
     */
    public ConstrainingClause clone() throws CloneNotSupportedException {
        ConstrainingClause node = (ConstrainingClause) super.clone();
        return node;
    }
    /**
     * @apilevel internal
     ...
     */
    public ConstrainingClause copy() {
        try {
            ConstrainingClause node = (ConstrainingClause) clone();
            node.parent = null;
            if(children != null) {
     ...
     */
    public ConstrainingClause fullCopy() {
     ...
     */
    public ConstrainingClause treeCopyNoTransform() {
        ConstrainingClause tree = (ConstrainingClause) copy();
        if (children != null) {
     ...
     */
    public ConstrainingClause treeCopy() {
        doFullTraversal();
        return treeCopyNoTransform();
    }
    /**
